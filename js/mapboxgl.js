    ...
    return (function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
            ...
            ArrayGroup.prototype.prepareSegment = function(r) {
                ...
                for (var t in this.layerData) {
                    var a = e.layerData[t];
                    0 !== a.paintVertexArray.bytesPerElement && a.programConfiguration.populatePaintArray(a.layer, a.paintVertexArray, e.layoutVertexArray.length, e.globalProperties, r) } }, ArrayGroup.prototype.isEmpty = function() {
        ...
        2: [function(require, module, exports) {
            ...
            var ArrayGroup = require("./array_group"),
                ...
                Bucket = function(r, e) { this.zoom = r.zoom, this.overscaling = r.overscaling, this.layers = r.layers, this.index = r.index, r.arrays ? this.buffers = new BufferGroup(e, r.layers, r.zoom, r.arrays) : this.arrays = new ArrayGroup(e, r.layers, r.zoom) };
            Bucket.prototype.populate = function(r, e) {
                for (var t = this, i = 0, u = r; i < u.length; i += 1) {
                    var a = u[i];
                    t.layers[0].filter(a) && (t.addFeature(a), e.featureIndex.insert(a, t.index)) } }, Bucket.prototype.isEmpty = function() {
                ...
                return { zoom: this.zoom, layerIds: this.layers.map(function(r) {
                        return r.id }), arrays: this.arrays.serialize(r) } }, Bucket.prototype.destroy = function() { this.buffers && (this.buffers.destroy(), this.buffers = null) }, module.exports = Bucket, Bucket.deserialize = function(r, e) {
                if (e) {
                    for (var t = {}, i = 0, u = r; i < u.length; i += 1) {
                        var a = u[i],
                            o = a.layerIds.map(function(r) {
                                return e.getLayer(r) }).filter(Boolean);
                        if (0 !== o.length)
                            for (var s = o[0].createBucket(util.extend({ layers: o }, a)), n = 0, f = o; n < f.length; n += 1) {
                                var l = f[n];
                                t[l.id] = s } }
                    return t } };
        ...
        3: [function(require, module, exports) {
            ...
            function addCircleVertex(e, r, t, a, p) { e.emplaceBack(2 * r + (a + 1) / 2, 2 * t + (p + 1) / 2) }
        ...
        }, { "../bucket": 2, "../element_array_type": 10, "../extent": 11, "../load_geometry": 13, "../vertex_array_type": 17 }],
        4: [function(require, module, exports) {
            ...
            var Bucket = require("../bucket"),
                ...
                fillInterface = { layoutVertexArrayType: createVertexArrayType([{ name: "a_pos", components: 2, type: "Int16" }]), elementArrayType: createElementArrayType(3), elementArrayType2: createElementArrayType(2), paintAttributes: [{ property: "fill-color", type: "Uint8" }, { property: "fill-outline-color", type: "Uint8" }, { property: "fill-opacity", type: "Uint8", multiplier: 255 }] },
                FillBucket = function(e) {
                    function r(r) { e.call(this, r, fillInterface) }
                    return e && (r.__proto__ = e), r.prototype = Object.create(e && e.prototype), r.prototype.constructor = r, r.prototype.addFeature = function(e) {
                        for (var r = this.arrays, t = 0, a = classifyRings(loadGeometry(e), EARCUT_MAX_RINGS); t < a.length; t += 1) {
                            ...
                            for (var i = r.prepareSegment(p), c = i.vertexLength, u = [], h = [], s = 0, g = l; s < g.length; s += 1) {
                                var m = g[s];
                                if (0 !== m.length) { m !== l[0] && h.push(u.length / 2);
        ...
        }, { "../../util/classify_rings": 111, "../bucket": 2, "../element_array_type": 10, "../load_geometry": 13, "../vertex_array_type": 17, "earcut": 133 }],
        5: [function(require, module, exports) {
            "use strict";

            function addVertex(e, r, t, a, n, y, o, i) { e.emplaceBack(r, t, 2 * Math.floor(a * FACTOR) + o, n * FACTOR * 2, y * FACTOR * 2, Math.round(i)) }
            ...
            var Bucket = require("../bucket"),
                ...
                classifyRings = require("../../util/classify_rings"),
                EARCUT_MAX_RINGS = 500,
                fillExtrusionInterface = { layoutVertexArrayType: createVertexArrayType([{ name: "a_pos", components: 2, type: "Int16" }, { name: "a_normal", components: 3, type: "Int16" }, { name: "a_edgedistance", components: 1, type: "Int16" }]), elementArrayType: createElementArrayType(3), paintAttributes: [{ property: "fill-extrusion-base", type: "Uint16" }, { property: "fill-extrusion-height", type: "Uint16" }, { property: "fill-extrusion-color", type: "Uint8" }] },
                FACTOR = Math.pow(2, 13),
                FillExtrusionBucket = function(e) {
                    function r(r) { e.call(this, r, fillExtrusionInterface) }
                    return e && (r.__proto__ = e), r.prototype = Object.create(e && e.prototype), r.prototype.constructor = r, r.prototype.addFeature = function(e) {
                        for (var r = this.arrays, t = 0, a = classifyRings(loadGeometry(e), EARCUT_MAX_RINGS); t < a.length; t += 1) {
                            ...
                            for (var p = r.prepareSegment(5 * y), u = [], c = [], x = [], s = 0, d = n; s < d.length; s += 1) {
                                var h = d[s];
                                if (0 !== h.length) { h !== n[0] && c.push(u.length / 2);
        ...
        }, { "../../util/classify_rings": 111, "../bucket": 2, "../element_array_type": 10, "../extent": 11, "../load_geometry": 13, "../vertex_array_type": 17, "earcut": 133 }],
                ...
                LineBucket = function(e) {
                    ...
                    return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.addFeature = function(e) {
                        for (var t = this, r = this.layers[0].layout, i = r["line-join"], a = r["line-cap"], n = r["line-miter-limit"], d = r["line-round-limit"], s = 0, u = loadGeometry(e, LINE_DISTANCE_BUFFER_BITS); s < u.length; s += 1) {
                            var l = u[s];
                            t.addLine(l, e.properties, i, a, n, d) } }, t.prototype.addLine = function(e, t, r, i, a, n) {
                        for (var d = this, s = e.length; s > 2 && e[s - 1].equals(e[s - 2]);) s--;
                        if (!(e.length < 2)) { "bevel" === r && (a = 1.05);
                            ...
                            if (2 !== s || !o) { this.distance = 0;
                                var h, y, m, E, x, C, A, f = i,
                                    v = o ? "butt" : i,
                                    L = !0;
                                this.e1 = this.e2 = this.e3 = -1, o && (h = e[s - 2], x = l.sub(h)._unit()._perp());
                                for (var S = 0; S < s; S++)
                                    if (m = o && S === s - 1 ? e[1] : e[S + 1], !m || !e[S].equals(m)) { x && (E = x), h && (y = h), h = e[S], x = m ? m.sub(h)._unit()._perp() : E, E = E || x;
                                        var V = E.add(x)._unit(),
                                            T = V.x * x.x + V.y * x.y,
                                            I = 1 / T,
                                        ...
                                        if (g && "round" === B && (I < n ? B = "miter" : I <= 2 && (B = "fakeround")), "miter" === B && I > a && (B = "bevel"), "bevel" === B && (I > 2 && (B = "flipbevel"), I < a && (B = "miter")), y && (d.distance += h.dist(y)), "miter" === B) V._mult(I), d.addCurrentVertex(h, d.distance, V, 0, 0, !1, _);
                                            ...
                                            if (I > 100) V = x.clone();
                                                ...
                                                V._perp()._mult(k * F) }
                                            d.addCurrentVertex(h, d.distance, V, 0, 0, !1, _), d.addCurrentVertex(h, d.distance, V.mult(-1), 0, 0, !1, _) } else if ("bevel" === B || "fakeround" === B) {
                                            ...
                                            m && d.addCurrentVertex(h, d.distance, x, -C, -A, !1, _) } else "butt" === B ? (L || d.addCurrentVertex(h, d.distance, E, 0, 0, !1, _), m && d.addCurrentVertex(h, d.distance, x, 0, 0, !1, _)) : "square" === B ? (L || (d.addCurrentVertex(h, d.distance, E, 1, 1, !1, _), d.e1 = d.e2 = -1), m && d.addCurrentVertex(h, d.distance, x, -1, -1, !1, _)) : "round" === B && (L || (d.addCurrentVertex(h, d.distance, E, 0, 0, !1, _), d.addCurrentVertex(h, d.distance, E, 1, 1, !0, _), d.e1 = d.e2 = -1), m && (d.addCurrentVertex(h, d.distance, x, -1, -1, !0, _), d.addCurrentVertex(h, d.distance, x, 0, 0, !1, _)));
                                        if (N && S < s - 1) {
                                            var X = h.dist(m);
                                            if (X > 2 * u) {
                                        ...
                                        L = !1 }
                                c.populatePaintArrays(t) } } }, t.prototype.addCurrentVertex = function(e, t, r, i, a, n, d) {
                        var s, u = n ? 1 : 0,
                            l = this.arrays,
                            p = l.layoutVertexArray,
                            o = l.elementArray;
                        s = r.clone(), i && s._sub(r.perp()._mult(i)), addLineVertex(p, e, s, u, 0, i, t), this.e3 = d.vertexLength++, this.e1 >= 0 && this.e2 >= 0 && (o.emplaceBack(this.e1, this.e2, this.e3), d.primitiveLength++), this.e1 = this.e2, this.e2 = this.e3, s = r.mult(-1), a && s._sub(r.perp()._mult(a)), addLineVertex(p, e, s, u, 1, -a, t), this.e3 = d.vertexLength++, this.e1 >= 0 && this.e2 >= 0 && (o.emplaceBack(this.e1, this.e2, this.e3), d.primitiveLength++), this.e1 = this.e2, this.e2 = this.e3, t > MAX_LINE_DISTANCE / 2 && (this.distance = 0, this.addCurrentVertex(e, this.distance, r, i, a, n, d)) }, t.prototype.addPieSliceVertex = function(e, t, r, i, a) {
                        var n = i ? 1 : 0;
                        r = r.mult(i ? -1 : 1);
                        var d = this.arrays,
        ...
        7: [function(require, module, exports) {
            ...
            function addVertex(e, t, o, a, r, n, i, s, l, y, c) { e.emplaceBack(t, o, Math.round(64 * a), Math.round(64 * r), n / 4, i / 4, 10 * (y || 0), c, 10 * (s || 0), 10 * Math.min(l || 25, 25)) }
            ...
            var Point = require("point-geometry"),
                ...
                layoutVertexArrayType = createVertexArrayType([{ name: "a_pos", components: 2, type: "Int16" }, { name: "a_offset", components: 2, type: "Int16" }, { name: "a_texture_pos", components: 2, type: "Uint16" }, { name: "a_data", components: 4, type: "Uint8" }]),
                symbolInterfaces = { glyph: { layoutVertexArrayType: layoutVertexArrayType, elementArrayType: elementArrayType }, icon: { layoutVertexArrayType: layoutVertexArrayType, elementArrayType: elementArrayType }, collisionBox: { layoutVertexArrayType: createVertexArrayType([{ name: "a_pos", components: 2, type: "Int16" }, { name: "a_extrude", components: 2, type: "Int16" }, { name: "a_data", components: 2, type: "Uint8" }]), elementArrayType: createElementArrayType(2) } },
                SymbolBucket = function(e) {
                    var t = this;
                    if (this.collisionBoxArray = e.collisionBoxArray, this.symbolQuadsArray = e.symbolQuadsArray, this.symbolInstancesArray = e.symbolInstancesArray, this.zoom = e.zoom, this.overscaling = e.overscaling, this.layers = e.layers, this.index = e.index, this.sdfIcons = e.sdfIcons, this.iconsNeedLinear = e.iconsNeedLinear, this.adjustedTextSize = e.adjustedTextSize, this.adjustedIconSize = e.adjustedIconSize, this.fontstack = e.fontstack, e.arrays) { this.buffers = {};
            ...
            SymbolBucket.prototype.populate = function(e, t) {
                ...
                if (this.features = [], s || l) {
                    for (var y = t.iconDependencies, c = t.glyphDependencies, d = c[n] = c[n] || {}, h = 0; h < e.length; h++) {
                        ...
                        if (o.layers[0].filter(x)) {
                            ...
                            s && (u = resolveText(x, a));
                            var m;
                            if (l && (m = resolveTokens(x.properties, i)), (u || m) && (o.features.push({ text: u, icon: m, index: h, sourceLayerIndex: x.sourceLayerIndex, geometry: loadGeometry(x), properties: x.properties, type: VectorTileFeature.types[x.type] }), m && (y[m] = !0), u))
                                for (var p = 0; p < u.length; p++) d[u.charCodeAt(p)] = !0 } } "line" === a["symbol-placement"] && (this.features = mergeLines(this.features)) } }, SymbolBucket.prototype.isEmpty = function() {
                return this.arrays.icon.isEmpty() && this.arrays.glyph.isEmpty() && this.arrays.collisionBox.isEmpty() }, SymbolBucket.prototype.serialize = function(e) {
                return { zoom: this.zoom, layerIds: this.layers.map(function(e) {
                        return e.id }), sdfIcons: this.sdfIcons, iconsNeedLinear: this.iconsNeedLinear, adjustedTextSize: this.adjustedTextSize, adjustedIconSize: this.adjustedIconSize, fontstack: this.fontstack, arrays: util.mapObject(this.arrays, function(t) {
                ...
                for (var s = "right" === r["text-justify"] ? 1 : "left" === r["text-justify"] ? 0 : .5, l = 24, y = r["text-line-height"] * l, c = "line" !== r["symbol-placement"] ? r["text-max-width"] * l : 0, d = r["text-letter-spacing"] * l, h = [r["text-offset"][0] * l, r["text-offset"][1] * l], x = this.fontstack = r["text-font"].join(","), u = "map" === r["text-rotation-alignment"] && "line" === r["symbol-placement"], m = 0, p = this.features; m < p.length; m += 1) {
                    ...
                    if (f.text) {
                        ...
                        g = {}, g[WritingMode.horizontal] = shapeText(f.text, e[x], c, y, n, i, s, d, h, l, WritingMode.horizontal), g[WritingMode.vertical] = b && u && shapeText(f.text, e[x], c, y, n, i, s, d, h, l, WritingMode.vertical) } else g = {};
                    var I;
                    if (f.icon) {
                        var v = t[f.icon],
                            S = o.layers[0].getLayoutValue("icon-offset", { zoom: o.zoom }, f.properties);
                        I = shapeIcon(v, S), v && (void 0 === o.sdfIcons ? o.sdfIcons = v.sdf : o.sdfIcons !== v.sdf && util.warnOnce("Style sheet warning: Cannot mix SDF and non-SDF icons in one buffer"), 1 !== v.pixelRatio ? o.iconsNeedLinear = !0 : 0 === r["icon-rotate"] && o.layers[0].isLayoutValueFeatureConstant("icon-rotate") || (o.iconsNeedLinear = !0)) }(g[WritingMode.horizontal] || I) && o.addFeature(f, g, I) }
                this.symbolInstancesEndIndex = this.symbolInstancesArray.length }, SymbolBucket.prototype.addFeature = function(e, t, o) {
                var a = this,
                    r = this.layers[0].layout,
                    n = 24,
                    i = this.adjustedTextSize / n,
                    s = void 0 !== this.adjustedTextMaxSize ? this.adjustedTextMaxSize : this.adjustedTextSize,
                    l = this.tilePixelRatio * i,
                    y = this.tilePixelRatio * s / n,
                ...
                if ("line" === b)
                    for (var S = 0, A = clipLine(e.geometry, 0, 0, EXTENT, EXTENT); S < A.length; S += 1)
                        for (var M = A[S], B = getAnchors(M, d, m, t[WritingMode.vertical] || t[WritingMode.horizontal], o, n, y, a.overscaling, EXTENT), T = 0, z = B; T < z.length; T += 1) {
                            var E = z[T],
                                k = t[WritingMode.horizontal];
                            k && a.anchorIsTooClose(k.text, I, E) || v(M, E) } else if ("Polygon" === e.type)
                            for (var P = 0, L = classifyRings(e.geometry, 0); P < L.length; P += 1) {
                                var w = L[P],
                                    V = findPoleOfInaccessibility(w, 16);
                                v(w[0], new Anchor(V.x, V.y, 0)) } else if ("LineString" === e.type)
                                for (var _ = 0, Q = e.geometry; _ < Q.length; _ += 1) {
                                    var j = Q[_];
                                    v(j, new Anchor(j[0].x, j[0].y, 0)) } else if ("Point" === e.type)
                                    for (var q = 0, C = e.geometry; q < C.length; q += 1)
                                        for (var F = C[q], N = 0, W = F; N < W.length; N += 1) {
                                            var X = W[N];
                                            v([X], new Anchor(X.x, X.y, 0)) } }, SymbolBucket.prototype.anchorIsTooClose = function(e, t, o) {
                var a = this.compareText;
                if (e in a) {
                    for (var r = a[e], n = r.length - 1; n >= 0; n--)
                        if (o.dist(r[n]) < t) return !0 } else a[e] = [];
                return a[e].push(o), !1 }, SymbolBucket.prototype.place = function(e, t) {
                var o = this;
                this.createArrays();
                var a = this.layers[0].layout,
                    r = e.maxScale,
                    n = "map" === a["text-rotation-alignment"] && "line" === a["symbol-placement"],
                    i = "map" === a["icon-rotation-alignment"] && "line" === a["symbol-placement"],
                ...
                for (var h = this.symbolInstancesStartIndex; h < this.symbolInstancesEndIndex; h++) {
                    var x = o.sortedSymbolInstances ? o.sortedSymbolInstances[h - o.symbolInstancesStartIndex] : o.symbolInstancesArray.get(h),
                        u = { boxStartIndex: x.textBoxStartIndex, boxEndIndex: x.textBoxEndIndex },
                        m = { boxStartIndex: x.iconBoxStartIndex, boxEndIndex: x.iconBoxEndIndex },
                ...
                t && this.addToDebugBuffers(e) }, SymbolBucket.prototype.addSymbols = function(e, t, o, a, r, n, i, s) {
                for (var l = this, y = e.elementArray, c = e.layoutVertexArray, d = this.zoom, h = Math.max(Math.log(a) / Math.LN2 + d, 0), x = t; x < o; x++) {
                    var u = l.symbolQuadsArray.get(x).SymbolQuad,
                        m = (u.anchorAngle + i + Math.PI) % (2 * Math.PI);
                    if (s & WritingMode.vertical) {
                        if (n && u.writingMode === WritingMode.vertical) {
                            if (r && n && m <= 5 * Math.PI / 4 || m > 7 * Math.PI / 4) continue } else if (r && n && m <= 3 * Math.PI / 4 || m > 5 * Math.PI / 4) continue } else if (r && n && (m <= Math.PI / 2 || m > 3 * Math.PI / 2)) continue;
                    var p = u.tl,
                        g = u.tr,
                        f = u.bl,
                        b = u.br,
                ...
                for (var t = this, o = this.arrays.collisionBox, a = o.layoutVertexArray, r = o.elementArray, n = -e.angle, i = e.yStretch, s = this.symbolInstancesStartIndex; s < this.symbolInstancesEndIndex; s++) {
                    ...
                    l.textCollisionFeature = { boxStartIndex: l.textBoxStartIndex, boxEndIndex: l.textBoxEndIndex }, l.iconCollisionFeature = { boxStartIndex: l.iconBoxStartIndex, boxEndIndex: l.iconBoxEndIndex };
                    for (var y = 0; y < 2; y++) {
                        ...
                        if (c)
                            for (var d = c.boxStartIndex; d < c.boxEndIndex; d++) {
                                var h = t.collisionBoxArray.get(d),
                                    x = h.anchorPoint,
                                    u = new Point(h.x1, h.y1 * i)._rotate(n),
                                    m = new Point(h.x2, h.y1 * i)._rotate(n),
                                    p = new Point(h.x1, h.y2 * i)._rotate(n),
                                    g = new Point(h.x2, h.y2 * i)._rotate(n),
                                    ...
                                    v = I.vertexLength;
                                addCollisionBoxVertex(a, x, u, f, b), addCollisionBoxVertex(a, x, m, f, b), addCollisionBoxVertex(a, x, g, f, b), addCollisionBoxVertex(a, x, p, f, b), r.emplaceBack(v, v + 1), r.emplaceBack(v + 1, v + 2), r.emplaceBack(v + 2, v + 3), r.emplaceBack(v + 3, v), I.vertexLength += 4, I.primitiveLength += 4 } } } }, SymbolBucket.prototype.addSymbolInstance = function(e, t, o, a, r, n, i, s, l, y, c, d, h, x, u, m, p, g, f) {
                var b, I, v, S = this,
                    A = [];
                for (var M in o) {
                    var B = parseInt(M, 10);
                ...
                var w = this.symbolQuadsArray.length,
                    V = I ? I.boxStartIndex : this.collisionBoxArray.length,
                    _ = I ? I.boxEndIndex : this.collisionBoxArray.length;
                ...
                return this.symbolInstancesArray.emplaceBack(k, P, V, _, T, E, L, w, e.x, e.y, i, Q) }, SymbolBucket.prototype.addSymbolQuad = function(e) {
                return this.symbolQuadsArray.emplaceBack(e.anchorPoint.x, e.anchorPoint.y, e.tl.x, e.tl.y, e.tr.x, e.tr.y, e.bl.x, e.bl.y, e.br.x, e.br.y, e.tex.h, e.tex.w, e.tex.x, e.tex.y, e.anchorAngle, e.glyphAngle, e.maxScale, e.minScale, e.writingMode) }, SymbolBucket.MAX_QUADS = 65535, module.exports = SymbolBucket;
        ...
        8: [function(require, module, exports) {
            ...
            var AttributeType = { Int8: "BYTE", Uint8: "UNSIGNED_BYTE", Int16: "SHORT", Uint16: "UNSIGNED_SHORT" },
                Buffer = function(e, t, r) { this.arrayBuffer = e.arrayBuffer, this.length = e.length, this.attributes = t.members, this.itemSize = t.bytesPerElement, this.type = r, this.arrayType = t };
            Buffer.fromStructArray = function(e, t) {
                return new Buffer(e.serialize(), e.constructor.serialize(), t) }, Buffer.prototype.bind = function(e) {
                var t = e[this.type];
                this.buffer ? e.bindBuffer(t, this.buffer) : (this.gl = e, this.buffer = e.createBuffer(), e.bindBuffer(t, this.buffer), e.bufferData(t, this.arrayBuffer, e.STATIC_DRAW), this.arrayBuffer = null) }, Buffer.prototype.setVertexAttribPointers = function(e, t, r) {
                for (var f = this, i = 0; i < this.attributes.length; i++) {
                    var u = f.attributes[i],
                        s = t[u.name];
                    void 0 !== s && e.vertexAttribPointer(s, u.components, e[AttributeType[u.type]], !1, f.arrayType.bytesPerElement, u.offset + (f.arrayType.bytesPerElement * r || 0)) } }, Buffer.prototype.destroy = function() { this.buffer && this.gl.deleteBuffer(this.buffer) }, Buffer.BufferType = { VERTEX: "ARRAY_BUFFER", ELEMENT: "ELEMENT_ARRAY_BUFFER" }, module.exports = Buffer;
        }, {}],
        ...
        12: [function(require, module, exports) {
            ...
            FeatureIndex.prototype.insert = function(e, t) {
                ...
                for (var n = loadGeometry(e), a = 0; a < n.length; a++) {
                    ...
                    r.grid.insert(i, s[0], s[1], s[2], s[3]) } }, FeatureIndex.prototype.setCollisionTile = function(e) { this.collisionTile = e }, FeatureIndex.prototype.serialize = function(e) {
                var t = this.grid.toArrayBuffer();
                return e && e.push(t), { coord: this.coord, overscaling: this.overscaling, grid: t, featureIndexArray: this.featureIndexArray.serialize(e), bucketLayerIDs: this.bucketLayerIDs } }, FeatureIndex.prototype.query = function(e, t) { this.vtLayers || (this.vtLayers = new vt.VectorTile(new Protobuf(this.rawTileData)).layers, this.sourceLayerCoder = new DictionaryCoder(this.vtLayers ? Object.keys(this.vtLayers).sort() : ["_geojsonTileLayer"]));
                var r = {},
                    i = e.params || {},
                ...
                for (var s in t) {
                    var l = t[s],
                        u = l.paint,
                        c = 0; "line" === l.type ? c = getLineWidth(u) / 2 + Math.abs(u["line-offset"]) + translateDistance(u["line-translate"]) : "fill" === l.type ? c = translateDistance(u["fill-translate"]) : "fill-extrusion" === l.type ? c = translateDistance(u["fill-extrusion-translate"]) : "circle" === l.type && (c = u["circle-radius"] + translateDistance(u["circle-translate"])), o = Math.max(o, c * n) }
                for (var y = e.queryGeometry.map(function(e) {
                        return e.map(function(e) {
                            return new Point(e.x, e.y) }) }), f = 1 / 0, d = 1 / 0, h = -(1 / 0), g = -(1 / 0), p = 0; p < y.length; p++)
                ...
                return L.sort(), this.filterMatching(r, L, this.collisionTile.collisionBoxArray, y, a, i.layers, t, e.bearing, n), r }, FeatureIndex.prototype.filterMatching = function(e, t, r, i, n, a, o, s, l) {
                            ...
                            if (n(v))
                                for (var x = null, I = 0; I < h.length; I++) {
                                    ...
                                    if (!(a && a.indexOf(m) < 0)) {
                                        ...
                                        if (L) {
                                            var M;
                                            if ("symbol" !== L.type) { x || (x = loadGeometry(v));
                                                var P = L.paint;
                                                if ("line" === L.type) { M = translate(i, P["line-translate"], P["line-translate-anchor"], s, l);
                                                    var b = getLineWidth(P) / 2 * l;
                                                    if (P["line-offset"] && (x = offsetLine(x, P["line-offset"] * l)), !multiPolygonIntersectsBufferedMultiLine(M, x, b)) continue } else if ("fill" === L.type || "fill-extrusion" === L.type) {
                                                    var w = L.type;
                                                    if (M = translate(i, P[w + "-translate"], P[w + "-translate-anchor"], s, l), !multiPolygonIntersectsMultiPolygon(M, x)) continue } else if ("circle" === L.type) { M = translate(i, P["circle-translate"], P["circle-translate-anchor"], s, l);
                                                    var _ = P["circle-radius"] * l;
                                                    if (!multiPolygonIntersectsBufferedMultiPoint(M, x, _)) continue } }
                                            var q = new GeoJSONFeature(v, c.z, c.x, c.y);
                                            q.layer = L.serialize();
                                            var T = e[m];
                                            void 0 === T && (T = e[m] = []), T.push(q) } } } } } } }, module.exports = FeatureIndex;
        }, { "../util/dictionary_coder": 113, "../util/intersection_tests": 120, "../util/struct_array": 125, "../util/util": 127, "../util/vectortile_to_geojson": 128, "./extent": 11, "./load_geometry": 13, "feature-filter": 135, "grid-index": 146, "pbf": 193, "point-geometry": 194, "vector-tile": 204 }],
        ...
        15: [function(require, module, exports) {
            ...
            ProgramConfiguration.createDynamic = function(t, e, r) {
                ...
                for (var e = new ProgramConfiguration, r = 0, i = t; r < i.length; r += 1) {
                    var a = i[r];
                    e.addUniform(a, "u_" + a) }
                return e }, ProgramConfiguration.prototype.addUniform = function(t, e) {
                var r = this.getPragmas(t);
                r.define.push("uniform {precision} {type} " + e + ";"), r.initialize.push("{precision} {type} " + t + " = " + e + ";"), this.cacheKey += "/u_" + t }, ProgramConfiguration.prototype.addZoomAttribute = function(t, e) { this.uniforms.push(e), this.addUniform(t, e.name) }, ProgramConfiguration.prototype.addPropertyAttribute = function(t, e) {
                var r = this.getPragmas(t);
                this.attributes.push(e), r.define.push("varying {precision} {type} " + t + ";"), r.vertex.define.push("attribute {precision} {type} " + e.name + ";"), r.vertex.initialize.push(t + " = " + e.name + " / " + e.multiplier + ".0;"), this.cacheKey += "/a_" + t }, ProgramConfiguration.prototype.addZoomAndPropertyAttribute = function(t, e, r, i) {
                var a = this,
                    n = this.getPragmas(t);
                ...
                var u = Math.max(0, Math.min(p.length - 4, o - 2)),
                    s = "u_" + t + "_t";
                n.vertex.define.push("uniform lowp float " + s + ";"), this.interpolationUniforms.push({ name: s, property: e.property, stopOffset: u });
                for (var m = [], f = 0; f < 4; f++) m.push(p[Math.min(u + f, p.length - 1)]);
                var g = [];
                if (1 === e.components) this.attributes.push(util.extend({}, e, { components: 4, zoomStops: m })), n.vertex.define.push("attribute {precision} vec4 " + e.name + ";"), g.push(e.name);
                else
                    for (var h = 0; h < 4; h++) {
                        var l = e.name + h;
                        g.push(l), a.attributes.push(util.extend({}, e, { name: l, zoomStops: [m[h]] })), n.vertex.define.push("attribute {precision} {type} " + l + ";") }
                n.vertex.initialize.push(t + " = evaluate_zoom_function_" + e.components + "(            " + g.join(", ") + ", " + s + ") / " + e.multiplier + ".0;"), this.cacheKey += "/z_" + t }, ProgramConfiguration.prototype.getPragmas = function(t) {
                return this.pragmas[t] || (this.pragmas[t] = { define: [], initialize: [] }, this.pragmas[t].fragment = { define: [], initialize: [] }, this.pragmas[t].vertex = { define: [], initialize: [] }), this.pragmas[t] }, ProgramConfiguration.prototype.applyPragmas = function(t, e) {
                var r = this;
                return t.replace(/#pragma mapbox: ([\w]+) ([\w]+) ([\w]+) ([\w]+)/g, function(t, i, a, n, o) {
                    return r.pragmas[o][i].concat(r.pragmas[o][e][i]).join("\n").replace(/{type}/g, n).replace(/{precision}/g, a) }) }, ProgramConfiguration.prototype.populatePaintArray = function(t, e, r, i, a) {
                var n = e.length;
                e.resize(r);
                for (var o = 0, p = this.attributes; o < p.length; o += 1)
                    for (var u = p[o], s = getPaintAttributeValue(u, t, i, a), m = n; m < r; m++) {
                        ...
                        else f[u.name] = s * u.multiplier } }, ProgramConfiguration.prototype.setUniforms = function(t, e, r, i) {
                ...
                for (var u = 0, s = this.interpolationUniforms; u < s.length; u += 1) {
                    ...
                    t.uniform1f(e[m.name], Math.max(0, Math.min(4, f - m.stopOffset))) } }, module.exports = ProgramConfiguration;
        ...
        21: [function(require, module, exports) {
            ...
            var LngLat = require("./lng_lat"),
                ...
                mat4 = glmatrix.mat4,
                mat2 = glmatrix.mat2,
                Transform = function(t, i) { this.tileSize = 512, this._minZoom = t || 0, this._maxZoom = i || 22, this.latRange = [-85.05113, 85.05113], this.width = 0, this.height = 0, this._center = new LngLat(0, 0), this.zoom = 0, this.angle = 0, this._fov = .6435011087932844, this._pitch = 0, this._unmodified = !0 },
                prototypeAccessors = { minZoom: {}, maxZoom: {}, worldSize: {}, centerPoint: {}, size: {}, bearing: {}, pitch: {}, fov: {}, zoom: {}, center: {}, unmodified: {}, x: {}, y: {}, point: {} };
            prototypeAccessors.minZoom.get = function() {
                ...
                return this._maxZoom }, prototypeAccessors.maxZoom.set = function(t) { this._maxZoom !== t && (this._maxZoom = t, this.zoom = Math.min(this.zoom, t)) }, prototypeAccessors.worldSize.get = function() {
                ...
                return (t.roundZoom ? Math.round : Math.floor)(this.zoom + this.scaleZoom(this.tileSize / t.tileSize)) }, Transform.prototype.coveringTiles = function(t) {
                ...
                this.center = this.coordinateLocation(this.locationCoordinate(t)._sub(o)) }, Transform.prototype.locationPoint = function(t) {
        ...
        }, { "../data/extent": 11, "../source/tile_coord": 51, "../util/interpolate": 119, "../util/util": 127, "./coordinate": 18, "./lng_lat": 19, "@mapbox/gl-matrix": 131, "point-geometry": 194 }],
        ...
        }, { "../data/buffer": 8, "../data/extent": 11, "../data/pos_array": 14, "../lib/debugtext": 23, "../util/browser": 108, "./vertex_array_object": 39, "@mapbox/gl-matrix": 131 }],
        ...
        30: [function(require, module, exports) {
            ...
            function ExtrusionTexture(t, e, r) { this.gl = t, this.width = e.width, this.height = e.height, this.painter = e, this.layer = r, this.texture = null, this.fbo = null, this.fbos = this.painter.preFbos[this.width] && this.painter.preFbos[this.width][this.height] }
            ...
            function setLight(t, e) {
                var r = e.gl,
                    ...
                    s = [a.x, a.y, a.z],
                    u = mat3.create(); "viewport" === i.calculated.anchor && mat3.fromRotation(u, -e.transform.angle), vec3.transformMat3(s, s, u), r.uniform3fv(t.u_lightpos, s), r.uniform1f(t.u_lightintensity, i.calculated.intensity), r.uniform3fv(t.u_lightcolor, i.calculated.color.slice(0, 3)) }
            ...
            module.exports = draw, ExtrusionTexture.prototype.bindFramebuffer = function() {
                ...
                if (this.texture = this.painter.getViewportTexture(this.width, this.height), t.activeTexture(t.TEXTURE1), this.texture ? t.bindTexture(t.TEXTURE_2D, this.texture) : (this.texture = t.createTexture(), t.bindTexture(t.TEXTURE_2D, this.texture), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, t.CLAMP_TO_EDGE), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_T, t.CLAMP_TO_EDGE), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, t.LINEAR), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, t.LINEAR), t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, this.width, this.height, 0, t.RGBA, t.UNSIGNED_BYTE, null), this.texture.width = this.width, this.texture.height = this.height), this.fbos) this.fbo = this.fbos.pop(), t.bindFramebuffer(t.FRAMEBUFFER, this.fbo), t.framebufferTexture2D(t.FRAMEBUFFER, t.COLOR_ATTACHMENT0, t.TEXTURE_2D, this.texture, 0);
                    ...
                    t.bindRenderbuffer(t.RENDERBUFFER, e), t.bindRenderbuffer(t.RENDERBUFFER, r), t.renderbufferStorage(t.RENDERBUFFER, t.RGBA4, this.width, this.height), t.renderbufferStorage(t.RENDERBUFFER, t.DEPTH_COMPONENT16, this.width, this.height), t.bindFramebuffer(t.FRAMEBUFFER, this.fbo), t.framebufferRenderbuffer(t.FRAMEBUFFER, t.COLOR_ATTACHMENT0, t.RENDERBUFFER, e), t.framebufferRenderbuffer(t.FRAMEBUFFER, t.DEPTH_ATTACHMENT, t.RENDERBUFFER, r), t.framebufferTexture2D(t.FRAMEBUFFER, t.COLOR_ATTACHMENT0, t.TEXTURE_2D, this.texture, 0) } }, ExtrusionTexture.prototype.unbindFramebuffer = function() { this.painter.bindDefaultFramebuffer(), this.fbos ? this.fbos.push(this.fbo) : (this.painter.preFbos[this.width] || (this.painter.preFbos[this.width] = {}), this.painter.preFbos[this.width][this.height] = [this.fbo]), this.painter.saveViewportTexture(this.texture) }, ExtrusionTexture.prototype.renderToMap = function() {
                var t = this.gl,
                    e = this.painter,
        ...
        }, { "../data/buffer": 8, "../data/pos_array": 14, "./pattern": 37, "./vertex_array_object": 39, "@mapbox/gl-matrix": 131 }],
            ...
            function getFadeValues(r, t, a, e) {
                ...
                if (r.sourceCache && i > 0) {
                    var o = Date.now(),
                        ...
                        c = e.coveringZoomLevel({ tileSize: s.tileSize, roundZoom: s.roundZoom }),
                        f = !t || Math.abs(t.coord.z - c) > Math.abs(r.coord.z - c),
                        d = util.clamp(f ? n : 1 - u, 0, 1);
                    return t ? { opacity: 1, mix: 1 - d } : { opacity: d, mix: 0 } }
        ...
        33: [function(require, module, exports) {
            ...
            function setSymbolDrawState(t, e, i, a, o, r, n, l, s, u, f) {
                ...
                if (m.uniform1i(t.u_rotate_with_map, o), m.uniform1i(t.u_pitch_with_map, r), m.activeTexture(m.TEXTURE0), m.uniform1i(t.u_texture, 0), i) {
                    ...
                    if (!c) return;
                    c.updateTexture(m), m.uniform2f(t.u_texsize, c.width / 4, c.height / 4) } else {
            ...
            function drawTileSymbols(t, e, i, a, o, r, n, l, s, u, f, m, p) {
                ...
                if (l) {
                    ...
                    c.uniform2f(t.u_extrude_scale, b, b) } else {
                ...
                for (var E = this.width / r, o = E / 2, T = t.length % 2 === 1, R = -h; R <= h; R++)
                    for (var u = e.nextRow + h + R, d = e.width * u, l = T ? -t[t.length - 1] : 0, x = t[0], A = 1, _ = 0; _ < this.width; _++) {
                        ...
                        if (i) {
                            ...
                            if (U) {
                                var X = o - Math.abs(f);
                                p = Math.sqrt(D * D + X * X) } else p = o - Math.sqrt(D * D + f * f) } else p = (U ? 1 : -1) * D;
        ...
        36: [function(require, module, exports) {
            ...
            var browser = require("../util/browser"),
                ...
                draw = { symbol: require("./draw_symbol"), circle: require("./draw_circle"), line: require("./draw_line"), fill: require("./draw_fill"), "fill-extrusion": require("./draw_fill_extrusion"), raster: require("./draw_raster"), background: require("./draw_background"), debug: require("./draw_debug") },
                Painter = function(e, r) { this.gl = e, this.transform = r, this.reusableTextures = {}, this.preFbos = {}, this.frameHistory = new FrameHistory, this.setup(), this.numSublayers = SourceCache.maxUnderzooming + SourceCache.maxOverzooming + 1, this.depthEpsilon = 1 / Math.pow(2, 16), this.lineWidthRange = e.getParameter(e.ALIASED_LINE_WIDTH_RANGE), this.basicFillProgramConfiguration = ProgramConfiguration.createStatic(["color", "opacity"]), this.emptyProgramConfiguration = new ProgramConfiguration };
            Painter.prototype.resize = function(e, r) {
                ...
                i.emplaceBack(0, 0, 0, 0), i.emplaceBack(EXTENT, 0, 32767, 0), i.emplaceBack(0, EXTENT, 0, 32767), i.emplaceBack(EXTENT, EXTENT, 32767, 32767), this.rasterBoundsBuffer = Buffer.fromStructArray(i, Buffer.BufferType.VERTEX), this.rasterBoundsVAO = new VertexArrayObject }, Painter.prototype.clearColor = function() {
                var e = this.gl;
                ...
                r ? r.push(e) : this.reusableTextures[e.size] = [e] }, Painter.prototype.saveViewportTexture = function(e) { this.reusableTextures.viewport || (this.reusableTextures.viewport = {}), this.reusableTextures.viewport.texture = e }, Painter.prototype.getTileTexture = function(e, r) {
                var t = this.reusableTextures[e];
                if (t) {
                    var i = t[r || e];
                    return i && i.length > 0 ? i.pop() : null } }, Painter.prototype.getViewportTexture = function(e, r) {
                if (this.reusableTextures.viewport) {
                    var t = this.reusableTextures.viewport.texture;
                    return t.width === e && t.height === r ? t : (this.gl.deleteTexture(t), void(this.reusableTextures.viewport.texture = null)) } }, Painter.prototype.lineWidth = function(e) { this.gl.lineWidth(util.clamp(e, this.lineWidthRange[0], this.lineWidthRange[1])) }, Painter.prototype.showOverdrawInspector = function(e) {
                ...
                for (var l = t.getProgramParameter(i, t.ACTIVE_ATTRIBUTES), h = { program: i, numAttributes: l }, u = 0; u < l; u++) {
                ...
                return h }, Painter.prototype._createProgramCached = function(e, r) { this.cache = this.cache || {};
        ...
        39: [function(require, module, exports) {
            ...
            VertexArrayObject.prototype.bind = function(e, t, r, i, n, o) { void 0 === e.extVertexArrayObject && (e.extVertexArrayObject = e.getExtension("OES_vertex_array_object"));
                var s = !this.vao || this.boundProgram !== t || this.boundVertexBuffer !== r || this.boundVertexBuffer2 !== n || this.boundElementBuffer !== i || this.boundVertexOffset !== o;!e.extVertexArrayObject || s ? (this.freshBind(e, t, r, i, n, o), this.gl = e) : e.extVertexArrayObject.bindVertexArrayOES(this.vao) }, VertexArrayObject.prototype.freshBind = function(e, t, r, i, n, o) {
                ...
                else { s = e.currentNumAttributes || 0;
                    for (var b = u; b < s; b++) e.disableVertexAttribArray(b) }
                for (var a = s; a < u; a++) e.enableVertexAttribArray(a);
                r.bind(e), r.setVertexAttribPointers(e, t, o), n && (n.bind(e), n.setVertexAttribPointers(e, t, o)), i && i.bind(e), e.currentNumAttributes = u }, VertexArrayObject.prototype.destroy = function() { this.vao && (this.gl.extVertexArrayObject.deleteVertexArrayOES(this.vao), this.vao = null) }, module.exports = VertexArrayObject;
        }, {}],
                ...
                GeoJSONSource = function(t) {
                    ...
                    return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.load = function() {
                        ...
                        this.fire("dataloading", { dataType: "source" }), this._updateWorkerData(function(e) {
                            return e ? void t.fire("error", { error: e }) : (t.fire("data", { dataType: "source" }), void t.fire("source.load")) }) }, e.prototype.onAdd = function(t) { this.load(), this.map = t }, e.prototype.setData = function(t) {
                        var e = this;
                        return this._data = t, this.fire("dataloading", { dataType: "source" }), this._updateWorkerData(function(t) {
                            return t ? e.fire("error", { error: t }) : void e.fire("data", { dataType: "source" }) }), this }, e.prototype._updateWorkerData = function(t) {
                        var e = this,
        ...
        }, { "../util/ajax": 107, "./geojson_wrapper": 42, "./vector_tile_worker_source": 53, "geojson-rewind": 137, "geojson-vt": 141, "supercluster": 198, "vt-pbf": 208 }],
        ...
        43: [function(require, module, exports) {
            ...
            var util = require("../util/util"),
                ...
                ImageSource = function(t) {
                    function e(e, o, r, i) { t.call(this), this.id = e, this.dispatcher = r, this.coordinates = o.coordinates, this.minzoom = 0, this.maxzoom = 22, this.tileSize = 512, this.setEventedParent(i), this.options = o }
                    return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.load = function() {
                        var t = this;
                        ...
                        return r.column = Math.round(r.column), r.row = Math.round(r.row), this.minzoom = this.maxzoom = r.zoom, this.coord = new TileCoord(r.zoom, r.column, r.row), this._tileCoords = o.map(function(t) {
                            ...
                            return new Point(Math.round((e.column - r.column) * EXTENT), Math.round((e.row - r.row) * EXTENT)) }), this.fire("data", { dataType: "source" }), this }, e.prototype._setTile = function(t) { this.tile = t;
                        var e = 32767,
        ...
        }, { "../data/buffer": 8, "../data/extent": 11, "../data/raster_bounds_array": 16, "../geo/lng_lat": 19, "../render/vertex_array_object": 39, "../util/ajax": 107, "../util/evented": 116, "../util/util": 127, "../util/window": 110, "./tile_coord": 51, "point-geometry": 194 }],
        ...
        47: [function(require, module, exports) {
            ...
            var util = require("../util/util"),
                ...
                RasterTileSource = function(e) {
                    function t(t, i, r, o) { e.call(this), this.id = t, this.dispatcher = r, this.setEventedParent(o), this.minzoom = 0, this.maxzoom = 22, this.roundZoom = !0, this.scheme = "xyz", this.tileSize = 512, this._loaded = !1, this.options = i, util.extend(this, util.pick(i, ["url", "scheme", "tileSize"])) }
                    return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.load = function() {
                        ...
                        this.fire("dataloading", { dataType: "source" }), loadTileJSON(this.options, function(t, i) {
                            return t ? e.fire("error", t) : (util.extend(e, i), e.fire("data", { dataType: "source" }), void e.fire("source.load")) }) }, t.prototype.onAdd = function(e) { this.load(), this.map = e }, t.prototype.serialize = function() {
                        return { type: "raster", url: this.url, tileSize: this.tileSize, tiles: this.tiles } }, t.prototype.loadTile = function(e, t) {
                        function i(i, r) {
        ...
        }, { "../util/ajax": 107, "../util/evented": 116, "../util/mapbox": 123, "../util/util": 127, "./load_tilejson": 44 }],
        ...
        }, { "../source/geojson_source": 40, "../source/image_source": 43, "../source/raster_tile_source": 47, "../source/vector_tile_source": 52, "../source/video_source": 54, "../util/util": 127 }],
        49: [function(require, module, exports) {
            ...
            var Source = require("./source"),
                ...
                SourceCache = function(e) {
                    function o(o, t, r) { e.call(this), this.id = o, this.dispatcher = r, this.on("source.load", function() { this._sourceLoaded = !0 }), this.on("error", function() { this._sourceErrored = !0 }), this.on("data", function(e) { this._sourceLoaded && "source" === e.dataType && (this.reload(), this.transform && this.update(this.transform)) }), this._source = Source.create(o, t, r, this), this._tiles = {}, this._cache = new Cache(0, this.unloadTile.bind(this)), this._isIdRenderable = this._isIdRenderable.bind(this) }
                    return e && (o.__proto__ = e), o.prototype = Object.create(e && e.prototype), o.prototype.constructor = o, o.prototype.onAdd = function(e) { this.map = e, this._source && this._source.onAdd && this._source.onAdd(e) }, o.prototype.onRemove = function(e) { this._source && this._source.onRemove && this._source.onRemove(e) }, o.prototype.loaded = function() {
                        var e = this;
                        ...
                        return !0 }, o.prototype.getSource = function() {
                        return this._source }, o.prototype.loadTile = function(e, o) {
                        return this._source.loadTile(e, o) }, o.prototype.unloadTile = function(e) {
                        if (this._source.unloadTile) return this._source.unloadTile(e) }, o.prototype.abortTile = function(e) {
                        if (this._source.abortTile) return this._source.abortTile(e) }, o.prototype.serialize = function() {
                        return this._source.serialize() }, o.prototype.prepare = function() {
                        if (this._sourceLoaded && this._source.prepare) return this._source.prepare() }, o.prototype.getIds = function() {
                        return Object.keys(this._tiles).map(Number).sort(compareKeyZoom) }, o.prototype.getRenderableIds = function() {
                        return this.getIds().filter(this._isIdRenderable) }, o.prototype._isIdRenderable = function(e) {
                        return this._tiles[e].hasData() && !this._coveredTiles[e] }, o.prototype.reload = function() {
                        var e = this;
                        this._cache.reset();
                        for (var o in this._tiles) {
                            var t = e._tiles[o]; "loading" !== t.state && (t.state = "reloading"), e.loadTile(e._tiles[o], e._tileLoaded.bind(e, e._tiles[o])) } }, o.prototype._tileLoaded = function(e, o) {
                        return o ? (e.state = "errored", void this._source.fire("error", { tile: e, error: o })) : (e.sourceCache = this, e.timeAdded = (new Date).getTime(), this._source.fire("data", { tile: e, coord: e.coord, dataType: "tile" }), void(this.map && (this.map.painter.tileExtentVAO.vao = null))) }, o.prototype.getTile = function(e) {
                        return this.getTileByID(e.id) }, o.prototype.getTileByID = function(e) {
                        return this._tiles[e] }, o.prototype.getZoom = function(e) {
                        return e.zoom + e.scaleZoom(e.tileSize / this._source.tileSize) }, o.prototype.findLoadedChildren = function(e, o, t) {
                        var r = this,
                            i = !1;
                        for (var s in this._tiles) {
                            ...
                            if (!(t[s] || !a.hasData() || a.coord.z <= e.z || a.coord.z > o)) {
                                ...
                                if (Math.floor(a.coord.x / n) === e.x && Math.floor(a.coord.y / n) === e.y)
                                    for (t[s] = !0, i = !0; a && a.coord.z - 1 > e.z;) {
                                        var d = a.coord.parent(r._source.maxzoom).id;
                                        a = r._tiles[d], a && a.hasData() && (delete t[s], t[d] = !0) } } }
                        return i }, o.prototype.findLoadedParent = function(e, o, t) {
                        for (var r = this, i = e.z - 1; i >= o; i--) { e = e.parent(r._source.maxzoom);
                            var s = r._tiles[e.id];
                            if (s && s.hasData()) return t[e.id] = !0, s;
                            if (r._cache.has(e.id)) return t[e.id] = !0, r._cache.get(e.id) } }, o.prototype.updateCacheSize = function(e) {
                        var o = Math.ceil(e.width / e.tileSize) + 1,
                            t = Math.ceil(e.height / e.tileSize) + 1,
                            r = o * t,
                            i = 5;
                        this._cache.setMaxSize(Math.floor(r * i)) }, o.prototype.update = function(e) {
                        var t = this;
                        if (this._sourceLoaded) {
                            var r, i, s, a;
                            this.updateCacheSize(e);
                            var n = (this._source.roundZoom ? Math.round : Math.floor)(this.getZoom(e)),
                                d = Math.max(n - o.maxOverzooming, this._source.minzoom),
                                c = Math.max(n + o.maxUnderzooming, this._source.minzoom),
                                h = {};
                            this._coveredTiles = {};
                            var u;
                            for (u = this.used ? this._source.coord ? [this._source.coord] : e.coveringTiles({ tileSize: this._source.tileSize, minzoom: this._source.minzoom, maxzoom: this._source.maxzoom, roundZoom: this._source.roundZoom, reparseOverscaled: this._source.reparseOverscaled }) : [], r = 0; r < u.length; r++) i = u[r], s = t.addTile(i), h[i.id] = !0, s.hasData() || t.findLoadedChildren(i, c, h) || (a = t.findLoadedParent(i, d, h), a && t.addTile(a.coord));
                            for (var l = {}, p = Object.keys(h), _ = 0; _ < p.length; _++) {
                                var m = p[_];
                                i = TileCoord.fromID(m), s = t._tiles[m], s && s.fadeEndTime >= Date.now() && (t.findLoadedChildren(i, c, h) && (h[m] = !0), a = t.findLoadedParent(i, d, l), a && t.addTile(a.coord)) }
                            var f;
                            for (f in l) h[f] || (t._coveredTiles[f] = !0);
                            for (f in l) h[f] = !0;
                            var v = util.keysDifference(this._tiles, h);
                            for (r = 0; r < v.length; r++) t.removeTile(+v[r]);
                            this.transform = e } }, o.prototype.addTile = function(e) {
                        var o = this._tiles[e.id];
                        if (o) return o;
                        var t = e.wrapped();
                        if (o = this._tiles[t.id], o || (o = this._cache.get(t.id), o && o.redoPlacement(this._source)), !o) {
                            var r = e.z,
                                i = r > this._source.maxzoom ? Math.pow(2, r - this._source.maxzoom) : 1;
                            o = new Tile(t, this._source.tileSize * i, this._source.maxzoom), this.loadTile(o, this._tileLoaded.bind(this, o)) }
                        return o.uses++, this._tiles[e.id] = o, this._source.fire("dataloading", { tile: o, coord: o.coord, dataType: "tile" }), o }, o.prototype.removeTile = function(e) {
                        var o = this._tiles[e];
                        o && (o.uses--, delete this._tiles[e], this._source.fire("data", { tile: o, coord: o.coord, dataType: "tile" }), o.uses > 0 || (o.hasData() ? this._cache.add(o.coord.wrapped().id, o) : (o.aborted = !0, this.abortTile(o), this.unloadTile(o)))) }, o.prototype.clearTiles = function() {
                        var e = this;
                        for (var o in this._tiles) e.removeTile(o);
                        this._cache.reset() }, o.prototype.tilesIn = function(e) {
                        ...
                        for (var u = 0; u < r.length; u++) {
                            var l = o._tiles[r[u]],
                                p = TileCoord.fromID(r[u]),
                                _ = [coordinateToTilePoint(p, l.sourceMaxZoom, new Coordinate(i, s, d)), coordinateToTilePoint(p, l.sourceMaxZoom, new Coordinate(a, n, d))];
                            if (_[0].x < EXTENT && _[0].y < EXTENT && _[1].x >= 0 && _[1].y >= 0) {
                                ...
                                var v = t[l.coord.id];
                                void 0 === v && (v = t[l.coord.id] = { tile: l, coord: p, queryGeometry: [], scale: Math.pow(2, o.transform.zoom - l.coord.z) }), v.queryGeometry.push(m) } }
                        var T = [];
                        for (var y in t) T.push(t[y]);
                        return T }, o.prototype.redoPlacement = function() {
                        for (var e = this, o = this.getIds(), t = 0; t < o.length; t++) {
                            var r = e.getTileByID(o[t]);
                            r.redoPlacement(e._source) } }, o.prototype.getVisibleCoordinates = function() {
        ...
        }, { "../data/extent": 11, "../geo/coordinate": 18, "../util/evented": 116, "../util/lru_cache": 122, "../util/util": 127, "./source": 48, "./tile": 50, "./tile_coord": 51 }],
            ...
            Tile.prototype.registerFadeDuration = function(e, t) {
                ...
                if ("unloaded" !== this.state) { this.collisionTile = new CollisionTile(e.collisionTile, this.collisionBoxArray), this.featureIndex.setCollisionTile(this.collisionTile);
                    for (var o in this.buckets) {
                        var s = i.buckets[o]; "symbol" === s.type && (s.destroy(), delete i.buckets[o]) }
                ...
                this.buckets = {}, this.collisionBoxArray = null, this.symbolQuadsArray = null, this.symbolInstancesArray = null, this.collisionTile = null, this.featureIndex = null, this.state = "unloaded" }, Tile.prototype.redoPlacement = function(e) {
                function t(t, i) { this.reloadSymbolData(i, e.map.style), e.fire("data", { tile: this, coord: this.coord, dataType: "tile" }), e.map && (e.map.painter.tileExtentVAO.vao = null), this.state = "loaded", this.redoWhenDone && (this.redoPlacement(e), this.redoWhenDone = !1) }
                if ("vector" === e.type || "geojson" === e.type) {
                    if ("loaded" !== this.state || "reloading" === this.state) return void(this.redoWhenDone = !0);
                    this.state = "reloading", e.dispatcher.send("redoPlacement", { type: e.type, uid: this.uid, source: e.id, angle: e.map.transform.angle, pitch: e.map.transform.pitch, showCollisionBoxes: e.map.showCollisionBoxes }, t.bind(this), this.workerID) } }, Tile.prototype.getBucket = function(e) {
                ...
                if (this.rawTileData) { this.vtLayers || (this.vtLayers = new vt.VectorTile(new Protobuf(this.rawTileData)).layers);
                    ...
                    if (o)
                        for (var s = featureFilter(t && t.filter), r = { z: this.coord.z, x: this.coord.x, y: this.coord.y }, a = 0; a < o.length; a++) {
                            var l = o.feature(a);
                            if (s(l)) {
                                var n = new GeoJSONFeature(l, i.coord.z, i.coord.x, i.coord.y);
                                n.tile = r, e.push(n) } } } }, Tile.prototype.hasData = function() {
                return "loaded" === this.state || "reloading" === this.state }, module.exports = Tile;
        }, { "../data/bucket": 2, "../data/feature_index": 12, "../symbol/collision_box": 76, "../symbol/collision_tile": 78, "../symbol/symbol_instances": 87, "../symbol/symbol_quads": 88, "../util/util": 127, "../util/vectortile_to_geojson": 128, "feature-filter": 135, "pbf": 193, "vector-tile": 204 }],
        51: [function(require, module, exports) {
            ...
            TileCoord.prototype.toString = function() {
                ...
                return scanTriangle(i[0], i[1], i[2], 0, e, r), scanTriangle(i[2], i[3], i[0], 0, e, r), Object.keys(n).map(function(t) {
                    return n[t] }) }, TileCoord.fromID = function(t) {
                var i = t % 32,
                    o = 1 << i,
                    r = (t - i) / 32,
                    e = r % o,
                ...
                VectorTileSource = function(e) {
                    ...
                    return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.load = function() {
                        ...
                        this.fire("dataloading", { dataType: "source" }), loadTileJSON(this._options, function(t, i) {
                            return t ? void e.fire("error", t) : (util.extend(e, i), e.fire("data", { dataType: "source" }), void e.fire("source.load")) }) }, t.prototype.onAdd = function(e) { this.load(), this.map = e }, t.prototype.serialize = function() {
                        ...
                        e.workerID ? "loading" === e.state ? e.reloadCallback = t : this.dispatcher.send("reloadTile", r, i.bind(this), e.workerID) : e.workerID = this.dispatcher.send("loadTile", r, i.bind(this)) }, t.prototype.abortTile = function(e) { this.dispatcher.send("abortTile", { uid: e.uid, type: this.type, source: this.id }, null, e.workerID) }, t.prototype.unloadTile = function(e) { e.unloadVectorData(), this.dispatcher.send("removeTile", { uid: e.uid, type: this.type, source: this.id }, null, e.workerID) }, t }(Evented);
            ...
            VectorTileWorkerSource.prototype.loadTile = function(e, r) {
                function t(e, t) {
                    return delete this.loading[o][i], e ? r(e) : t ? (a.vectorTile = t, a.parse(t, this.layerIndex, this.actor, function(e, o, i) {
                        return e ? r(e) : void r(null, util.extend({ rawTileData: t.rawData }, o), i) }), this.loaded[o] = this.loaded[o] || {}, void(this.loaded[o][i] = a)) : r(null, null) }
                var o = e.source,
                    i = e.uid;
        ...
        54: [function(require, module, exports) {
            ...
            var ajax = require("../util/ajax"),
                ...
                VideoSource = function(t) {
                    function e(e, o, i, r) { t.call(this, e, o, i, r), this.roundZoom = !0, this.options = o }
                    return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.load = function() {
                        var t = this,
                            e = this.options;
        ...
        55: [function(require, module, exports) {
            ...
            Worker.prototype.setLayers = function(e, r) { this.getLayerIndex(e).replace(r) }, Worker.prototype.updateLayers = function(e, r) { this.getLayerIndex(e).update(r.layers, r.removedIds, r.symbolOrder) }, Worker.prototype.loadTile = function(e, r, o) { this.getWorkerSource(e, r.type).loadTile(r, o) }, Worker.prototype.reloadTile = function(e, r, o) { this.getWorkerSource(e, r.type).reloadTile(r, o) }, Worker.prototype.abortTile = function(e, r) { this.getWorkerSource(e, r.type).abortTile(r) }, Worker.prototype.removeTile = function(e, r) { this.getWorkerSource(e, r.type).removeTile(r) }, Worker.prototype.removeSource = function(e, r) {
                ...
                try { this.self.importScripts(r.url), o() } catch (e) { o(e) } }, Worker.prototype.getLayerIndex = function(e) {
                ...
                if (this.workerSources[e] || (this.workerSources[e] = {}), !this.workerSources[e][r]) {
                    var t = { send: function(r, t, i, s) { o.actor.send(r, t, i, s, e) } };
                ...
                return new Worker(e) };
        }, { "../style/style_layer_index": 69, "../util/actor": 106, "./geojson_worker_source": 41, "./vector_tile_worker_source": 53 }],
        56: [function(require, module, exports) {
            ...
            WorkerTile.prototype.parse = function(e, r, i, s) {
                ...
                var a = {},
                    n = 0,
                    c = { featureIndex: t, iconDependencies: {}, glyphDependencies: {} },
                    u = r.familiesBySource[this.source];
                for (var y in u) {
                    var h = e.layers[y];
                    if (h) { 1 === h.version && util.warnOnce('Vector tile source "' + o.source + '" layer "' + y + '" does not use vector tile spec v2 and therefore may have some rendering errors.');
                        ...
                        for (var f = 0, p = u[y]; f < p.length; f += 1) {
                            ...
                            if (!(x.minzoom && o.zoom < x.minzoom || x.maxzoom && o.zoom >= x.maxzoom || x.layout && "none" === x.layout.visibility)) {
                                ...
                                var k = a[x.id] = x.createBucket({ index: n, layers: g, zoom: o.zoom, overscaling: o.overscaling, collisionBoxArray: o.collisionBoxArray, symbolQuadsArray: o.symbolQuadsArray, symbolInstancesArray: o.symbolInstancesArray });
                                k.populate(d, c), t.bucketLayerIDs[n] = g.map(function(e) {
                                    return e.id }), n++ } } } }
                var I = function(e) { o.status = "done";
                    var r = [];
                    s(null, { buckets: serializeBuckets(util.values(a), r), featureIndex: t.serialize(r), collisionTile: e.serialize(r), collisionBoxArray: o.collisionBoxArray.serialize(), symbolInstancesArray: o.symbolInstancesArray.serialize(), symbolQuadsArray: o.symbolQuadsArray.serialize() }, r) };
                this.symbolBuckets = [];
                ...
                var T = 0,
                    ...
                    O = function(e) {
                        ...
                        if (T++, 2 === T) {
                            ...
                            I(r) } };
                Object.keys(D).length ? i.send("getGlyphs", { uid: this.uid, stacks: D }, function(e, r) { D = r, O(e) }) : O(), q.length ? i.send("getIcons", { icons: q }, function(e, r) { q = r, O(e) }) : O() }, WorkerTile.prototype.redoPlacement = function(e, r, i) {
                var s = this;
                ...
                var n = [];
                return { result: { buckets: serializeBuckets(this.symbolBuckets, n), collisionTile: o.serialize(n) }, transferables: n } }, module.exports = WorkerTile;
        }, { "../data/feature_index": 12, "../symbol/collision_box": 76, "../symbol/collision_tile": 78, "../symbol/symbol_instances": 87, "../symbol/symbol_quads": 88, "../util/dictionary_coder": 113, "../util/util": 127 }],
            ...
            var styleSpec = require("./style_spec"),
                ...
                Light = function(t) {
                    ...
                    return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.set = function(t) {
                        ...
                        var i = this;
                        for (var e in this._declarations) i.calculated[e] = i.getLightValue(e, { zoom: t }) }, i.prototype._applyLightDeclaration = function(t, i, e, o, n) {
                        ...
                        var o, n = this;
                        for (o in this._declarations) n._applyLightDeclaration(o, n._declarations[o], t, i, e) }, i.prototype._validate = function(t, i) {
        ...
        }, { "../util/evented": 116, "../util/util": 127, "./style_declaration": 62, "./style_spec": 70, "./style_transition": 71, "./validate_style": 72 }],
        60: [function(require, module, exports) {
            ...
            module.exports = function r(o) {
                if (o && MapboxGLFunction.isFunctionDefinition(o)) return o.stops ? util.extend({}, o, { stops: o.stops.map(function(o) {
                        return [o[0], r(o[1])] }) }) : o;
                if ("string" == typeof o) {
                    if (!cache[o]) {
            ...
            var Evented = require("../util/evented"),
                ...
                Style = function(e) {
                    function t(t, r, i) {
                        ...
                        var s = function(e, t) {
                            ...
                            if (!i.validate || !validateStyle.emitErrors(o, validateStyle(t))) { o._loaded = !0, o.stylesheet = t, o.updateClasses();
                                ...
                                t.sprite && (o.sprite = new ImageSprite(t.sprite, o)), o.glyphSource = new GlyphSource(t.glyphs), o._resolve(), o.fire("data", { dataType: "style" }), o.fire("style.load") } }; "string" == typeof t ? ajax.getJSON(mapbox.normalizeStyleURL(t), s) : browser.frame(s.bind(this, null, t)), this.on("source.load", function(e) {
                    ...
                    return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype._validateLayer = function(e) {
                        ...
                        var i = ["vector", "raster", "geojson", "video", "image"],
                        ...
                        if (!o || !this._validate(validateStyle.source, "sources." + e, t, null, r)) {
                            ...
                            s.style = this, s.setEventedParent(this, function() {
                                return { isSourceLoaded: s.loaded(), source: s.serialize(), sourceId: e } }), s.onAdd(this.map), this._changed = !0 } }, t.prototype.removeSource = function(e) {
                        ...
                        if ("object" == typeof e.source && (this.addSource(i, e.source), e = util.extend(e, { source: i })), !this._validate(validateStyle.layer, "layers." + i, e, { arrayIndex: -1 }, r)) {
                            ...
                            this._order.splice(s, 0, i), this._layers[i] = o, this._removedLayers[i] && (delete this._removedLayers[i], this._updatedSources[o.source] = "clear"), this._updateLayer(o), "symbol" === o.type && (this._updatedSymbolOrder = !0), this.updateClasses(i) } }, t.prototype.moveLayer = function(e, t) { this._checkLoaded(), this._changed = !0;
                        ...
                        this._order.splice(r, 1), "symbol" === t.type && (this._updatedSymbolOrder = !0), this._changed = !0, this._removedLayers[e] = !0, delete this._layers[e], delete this._updatedLayers[e], delete this._updatedPaintProps[e] }, t.prototype.getLayer = function(e) {
                        ...
                        if (t && t.layers)
                            for (var a = 0, n = t.layers; a < n.length; a += 1) {
                                var l = n[a],
                                    h = o._layers[l];
                                if (!h) return void o.fire("error", { error: "The layer '" + l + "' does not exist in the map's style and cannot be queried for features." });
                                s[h.source] = !0 }
                        var d = [];
                        for (var u in this.sourceCaches)
                            if (!t.layers || s[u]) {
                                ...
                                d.push(c) }
                        return this._flattenRenderedFeatures(d) }, t.prototype.querySourceFeatures = function(e, t) { t && t.filter && this._validate(validateStyle.filter, "querySourceFeatures.filter", t.filter);
                        ...
                        var t = this;
                        for (var r in this.sourceCaches) t.sourceCaches[r].update(e) }, t.prototype._redoPlacement = function() {
                        var e = this;
                        for (var t in this.sourceCaches) e.sourceCaches[t].redoPlacement() }, t.prototype.getIcons = function(e, t, r) {
                        var i = this,
                            o = function() { i.spriteAtlas.setSprite(i.sprite), i.spriteAtlas.addIcons(t.icons, r) };
                        this.sprite.loaded() ? o() : this.sprite.on("data", o) }, t.prototype.getGlyphs = function(e, t, r) {
            ...
            var MapboxGLFunction = require("mapbox-gl-function"),
                ...
                StyleDeclaration = function(t, o) {
                    ...
                    var n = this.isColor && this.value ? parseColor(this.value) : o,
                        s = t.default;
                    if (s && "color" === t.type && (s = parseColor(s)), this.function = MapboxGLFunction[t.function || "piecewise-constant"](n, s), this.isFeatureConstant = this.function.isFeatureConstant, this.isZoomConstant = this.function.isZoomConstant, !this.isFeatureConstant && !this.isZoomConstant) { this.stopZoomLevels = [];
                        for (var e = [], a = 0, r = this.value.stops; a < r.length; a += 1) {
                            var l = r[a],
                                u = l[0].zoom;
                            i.stopZoomLevels.indexOf(u) < 0 && (i.stopZoomLevels.push(u), e.push([u, e.length])) }
                        this.functionInterpolationT = MapboxGLFunction.interpolated({ stops: e, base: o.base, colorSpace: o.colorSpace }) } };
            StyleDeclaration.prototype.calculate = function(t, o) {
                var i = this.function(t && t.zoom, o || {});
                return this.isColor && i ? parseColor(i) : void 0 !== this.minimum && i < this.minimum ? this.minimum : i }, StyleDeclaration.prototype.calculateInterpolationT = function(t, o) {
                return this.functionInterpolationT(t && t.zoom, o || {}) }, module.exports = StyleDeclaration;
            ...
            var util = require("../util/util"),
                ...
                StyleLayer = function(t) {
                    ...
                    return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.setLayoutProperty = function(t, i, a) {
                        ...
                        return n ? n.calculate(i, a) : e.default }, i.prototype.setPaintProperty = function(t, i, a, e) {
                        ...
                        return n ? n.calculate(i, a) : "color" === e.type && e.default ? parseColor(e.default) : e.default }, i.prototype.getPaintValueStopZoomLevels = function(t) {
                        var i = this._paintTransitions[t];
                        return i ? i.declaration.stopZoomLevels : [] }, i.prototype.getPaintInterpolationT = function(t, i) {
                        var a = this._paintTransitions[t];
                        return a.declaration.calculateInterpolationT(i) }, i.prototype.isPaintValueFeatureConstant = function(t) {
                        var i = this._paintTransitions[t];
                        ...
                        var i = this._paintTransitions[t];
                        return !i || i.declaration.isZoomConstant }, i.prototype.isHidden = function(t) {
                        return !!(this.minzoom && t < this.minzoom) || (!!(this.maxzoom && t >= this.maxzoom) || "none" === this.layout.visibility) }, i.prototype.updatePaintTransitions = function(t, i, a, e, n) {
                        ...
                        for (l in this._paintTransitions) l in r || o._applyPaintDeclaration(l, null, i, a, e, n) }, i.prototype.updatePaintTransition = function(t, i, a, e, n, o) {
                        for (var r = this, s = this._paintDeclarations[""][t], l = 0; l < i.length; l++) {
                            var u = r._paintDeclarations[i[l]];
                            u && u[t] && (s = u[t]) }
                        this._applyPaintDeclaration(t, s, a, e, n, o) }, i.prototype.recalculate = function(t) {
                        var i = this;
                        for (var a in this._paintTransitions) i.paint[a] = i.getPaintValue(a, { zoom: t });
                        for (var e in this._layoutFunctions) i.layout[e] = i.getLayoutValue(e, { zoom: t }) }, i.prototype.serialize = function() {
                        var t = this,
                        ...
                        return util.filterObject(i, function(t, i) {
                            return void 0 !== t && !("layout" === i && !Object.keys(t).length) }) }, i.prototype._applyPaintDeclaration = function(t, i, a, e, n, o) {
                        ...
                        if (null !== i && void 0 !== i || (i = new StyleDeclaration(s, s.default)), !r || r.declaration.json !== i.json) {
                            ...
                            u.instant() || (u.loopID = n.set(u.endTime - Date.now())), r && n.cancel(r.loopID) } }, i.prototype._updateLayoutValue = function(t) {
                        var i = this._layoutDeclarations[t];
                        i && i.isFunction ? this._layoutFunctions[t] = !0 : (delete this._layoutFunctions[t], this.layout[t] = this.getLayoutValue(t)) }, i.prototype._validate = function(t, i, a, e, n) {
                        return (!n || n.validate !== !1) && validateStyle.emitErrors(this, t.call(validateStyle, { key: i, layerType: this.type, objectKey: a, value: e, styleSpec: styleSpec, style: { glyphs: !0, sprite: !0 } })) }, i }(Evented);
            module.exports = StyleLayer;
            var subclasses = { circle: require("./style_layer/circle_style_layer"), fill: require("./style_layer/fill_style_layer"), "fill-extrusion": require("./style_layer/fill_extrusion_style_layer"), line: require("./style_layer/line_style_layer"), symbol: require("./style_layer/symbol_style_layer") };
            StyleLayer.create = function(t) {
                var i = subclasses[t.type] || StyleLayer;
                return new i(t) };
        }, { "../util/evented": 116, "../util/util": 127, "./parse_color": 60, "./style_declaration": 62, "./style_layer/circle_style_layer": 64, "./style_layer/fill_extrusion_style_layer": 65, "./style_layer/fill_style_layer": 66, "./style_layer/line_style_layer": 67, "./style_layer/symbol_style_layer": 68, "./style_spec": 70, "./style_transition": 71, "./validate_style": 72 }],
            ...
            var StyleLayer = require("../style_layer"),
                ...
                FillStyleLayer = function(t) {
                    ...
                    return t && (o.__proto__ = t), o.prototype = Object.create(t && t.prototype), o.prototype.constructor = o, o.prototype.getPaintValue = function(o, l, e) {
                        return "fill-outline-color" === o && void 0 === this.getPaintProperty("fill-outline-color") ? t.prototype.getPaintValue.call(this, "fill-color", l, e) : t.prototype.getPaintValue.call(this, o, l, e) }, o.prototype.getPaintValueStopZoomLevels = function(o) {
        ...
        69: [function(require, module, exports) {
            ...
            StyleLayerIndex.prototype.replace = function(e) {
                ...
                for (var i = this, a = 0, l = e; a < l.length; a += 1) {
                    ...
                    o.updatePaintTransitions({}, { transition: !1 }), o.filter = featureFilter(o.filter) }
                ...
                for (var f = groupByLayout(util.values(this._layerConfigs)), p = 0, d = f; p < d.length; p += 1) {
                    ...
                    if (!c.layout || "none" !== c.layout.visibility) {
                        ...
                        var m = c.sourceLayer || "_geojsonTileLayer",
                            L = _[m];
                        L || (L = _[m] = []), L.push(v) } } }, module.exports = StyleLayerIndex;
        }, { "../util/util": 127, "./style_layer": 63, "feature-filter": 135, "mapbox-gl-style-spec/lib/group_by_layout": 164 }],
        ...
        80: [function(require, module, exports) {
            ...
            var ShelfPack = require("shelf-pack"),
                ...
                DEFAULT_SIZE = 128,
                MAX_SIZE = 2048,
                GlyphAtlas = function() { this.width = DEFAULT_SIZE, this.height = DEFAULT_SIZE, this.bin = new ShelfPack(this.width, this.height), this.index = {}, this.ids = {}, this.data = new Uint8Array(this.width * this.height) };
            GlyphAtlas.prototype.getGlyphs = function() {
                ...
                return this.dirty = !0, l }, GlyphAtlas.prototype.resize = function() {
                var t = this,
                    i = this.width,
                    e = this.height;
                if (!(i >= MAX_SIZE || e >= MAX_SIZE)) { this.texture && (this.gl && this.gl.deleteTexture(this.texture), this.texture = null), this.width *= SIZE_GROWTH_RATE, this.height *= SIZE_GROWTH_RATE, this.bin.resize(this.width, this.height);
        ...
        }, { "../symbol/glyph_atlas": 80, "../util/ajax": 107, "../util/glyphs": 118, "../util/mapbox": 123, "../util/verticalize_punctuation": 129, "pbf": 193 }],
        ...
        83: [function(require, module, exports) {
            ...
            function SymbolQuad(t, e, a, n, i, o, l, h, r, s, g) { this.anchorPoint = t, this.tl = e, this.tr = a, this.bl = n, this.br = i, this.tex = o, this.anchorAngle = l, this.glyphAngle = h, this.minScale = r, this.maxScale = s, this.writingMode = g }
            ...
            function getIconQuads(t, e, a, n, i, o, l, h, r) {
                ...
                if ("none" !== f["icon-text-fit"] && l) {
                    ...
                    s = new Point(S + L - R, I + z - k), g = new Point(S + L + q + V, I + z - k), u = new Point(S + L + q + V, I + z + A + j), c = new Point(S + L - R, I + z + A + j) } else s = new Point(d, y), g = new Point(P, y), u = new Point(P, M), c = new Point(d, M);
                    ...
                    if (c) {
                        ...
                        if (m) {
                            var f, x = (u.x + c.advance / 2) * a,
                                d = minScale;
                            o ? (f = [], d = getSegmentGlyphs(f, t, x, n, t.segment, !0), h && (d = Math.min(d, getSegmentGlyphs(f, t, x, n, t.segment, !1)))) : f = [{ anchorPoint: new Point(t.x, t.y), offset: 0, angle: 0, maxScale: 1 / 0, minScale: minScale }];
                            var P = u.x + c.left,
                                y = u.y - c.top,
                                M = P + m.w,
                                p = y + m.h,
            ...
            function getSegmentGlyphs(t, e, a, n, i, o) {
                ...
                for (var g = minScale;;) {
                    ...
                    if (o || (m += Math.PI), t.push({ anchorPoint: h, offset: l ? Math.PI : 0, minScale: c, maxScale: s, angle: (m + 2 * Math.PI) % (2 * Math.PI) }), c <= g) break;
                    for (h = r; h.equals(r);)
        ...
        85: [function(require, module, exports) {
            ...
            function PositionedGlyph(e, t, i, n, a) { this.codePoint = e, this.x = t, this.y = i, this.glyph = n || null, this.angle = a }

            function Shaping(e, t, i, n, a, r, o) { this.positionedGlyphs = e, this.text = t, this.top = i, this.bottom = n, this.left = a, this.right = r, this.writingMode = o }
            ...
            function shapeText(e, t, i, n, a, r, o, h, s, l, c) { e = e.trim(), c === WritingMode.vertical && (e = verticalizePunctuation(e));
                var u = [],
                    d = new Shaping(u, e, s[1], s[1], s[0], s[0], c),
                    g = c === WritingMode.horizontal && i ? breakLines(e, determineLineBreaks(e, h, i, t)) : [e];
                return shapeLines(d, t, g, n, a, r, o, s, c, h, l), !!u.length && d }
            ...
            function determineAverageLineWidth(e, t, i, n) {
                ...
                for (var r in e) {
                    ...
                    o && (a += o.advance + t) }
                var h = Math.max(1, Math.ceil(a / i));
                return a / h }
            ...
            function evaluateBreak(e, t, i, n, a, r) {
                for (var o = null, h = calculateBadness(t, i, a, r), s = 0, l = n; s < l.length; s += 1) {
                    var c = l[s],
                        u = t - c.x,
                        d = calculateBadness(u, i, a, r) + c.badness;
                    d <= h && (o = c, h = d) }
                return { index: e, x: t, priorBreak: o, badness: h } }
            ...
            function determineLineBreaks(e, t, i, n) {
                if (!i) return [];
                if (!e) return [];
                for (var a = [], r = determineAverageLineWidth(e, t, i, n), o = 0, h = 0; h < e.length; h++) {
                    var s = e.charCodeAt(h),
                        l = n[s];
                    l && !whitespace[s] && (o += l.advance + t), h < e.length - 1 && (breakable[s] || scriptDetection.charAllowsIdeographicBreaking(s)) && a.push(evaluateBreak(h + 1, o, r, a, calculatePenalty(s, e.charCodeAt(h + 1)), !1)) }
                return leastBadBreaks(evaluateBreak(e.length, o, r, a, 0, !0)) }

            function shapeLines(e, t, i, n, a, r, o, h, s, l, c) {
                var u = -17,
                    d = 0,
                    g = u,
                    p = 0,
                ...
                for (var f in i) {
                    var B = i[f].trim();
                    if (B.length) {
                        for (var b = v.length, k = 0; k < B.length; k++) {
                            var x = B.charCodeAt(k),
                                m = t[x];
                            m && (scriptDetection.charHasUprightVerticalOrientation(x) && s !== WritingMode.horizontal ? (v.push(new PositionedGlyph(x, d, 0, m, -Math.PI / 2)), d += c + l) : (v.push(new PositionedGlyph(x, d, g, m, 0)), d += m.advance + l)) }
                        if (v.length !== b) {
                            var w = d - l;
                            p = Math.max(w, p), justifyLine(v, t, b, v.length - 1, o) }
                        d = 0, g += n } else g += n }
                align(v, o, a, r, p, n, i.length, h);
                var M = i.length * n;
                e.top += -r * M, e.bottom = e.top + M, e.left += -a * p, e.right = e.left + p }

            function justifyLine(e, t, i, n, a) {
                if (a)
                    for (var r = t[e[n].codePoint].advance, o = (e[n].x + r) * a, h = i; h <= n; h++) e[h].x -= o }

            function align(e, t, i, n, a, r, o, h) {
                for (var s = (t - i) * a + h[0], l = (-n * o + .5) * r + h[1], c = 0; c < e.length; c++) e[c].x += s, e[c].y += l }
            ...
            function shapeIcon(e, t) {
                ...
                var i = t[0],
                    ...
                    o = n - e.height / 2,
                    h = o + e.height;
                return new PositionedIcon(e, o, h, a, r) }

            function PositionedIcon(e, t, i, n, a) { this.image = e, this.top = t, this.bottom = i, this.left = n, this.right = a }
            ...
            var newLine = 10,
                whitespace = { 9: !0, 10: !0, 11: !0, 12: !0, 13: !0, 32: !0 },
                breakable = { 32: !0, 38: !0, 40: !0, 41: !0, 43: !0, 45: !0, 47: !0, 173: !0, 183: !0, 8203: !0, 8208: !0, 8211: !0, 8231: !0 };
            breakable[newLine] = !0;
        ...
        86: [function(require, module, exports) {
            ...
            var ShelfPack = require("shelf-pack"),
                browser = require("../util/browser"),
                util = require("../util/util"),
                AtlasImage = function(t, i, e, h, a) { this.rect = t, this.width = i, this.height = e, this.sdf = h, this.pixelRatio = a },
                SpriteAtlas = function(t, i) { this.width = t, this.height = i, this.bin = new ShelfPack(t, i), this.images = {}, this.data = !1, this.texture = 0, this.filter = 0, this.pixelRatio = 1, this.dirty = !0 };
            SpriteAtlas.prototype.allocateImage = function(t, i) { t /= this.pixelRatio, i /= this.pixelRatio;
                var e = 2,
                    h = t + e + (4 - (t + e) % 4),
                    a = i + e + (4 - (i + e) % 4),
                ...
                h !== this.filter && (t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, h), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, h), this.filter = h), this.dirty && (this.allocate(), e ? t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, this.width * this.pixelRatio, this.height * this.pixelRatio, 0, t.RGBA, t.UNSIGNED_BYTE, new Uint8Array(this.data.buffer)) : t.texSubImage2D(t.TEXTURE_2D, 0, 0, 0, this.width * this.pixelRatio, this.height * this.pixelRatio, t.RGBA, t.UNSIGNED_BYTE, new Uint8Array(this.data.buffer)), this.dirty = !1) }, module.exports = SpriteAtlas;
        ...
        87: [function(require, module, exports) {
            ...
            Object.defineProperty(SymbolInstancesArray.prototype.StructType.prototype, "anchorPoint", { get: function() {
                    return new Point(this.anchorPointX, this.anchorPointY) } }), module.exports = SymbolInstancesArray;
        }, { "../util/struct_array": 125, "point-geometry": 194 }],
        88: [function(require, module, exports) {
            ...
            var createStructArrayType = require("../util/struct_array"),
                ...
                SymbolQuadsArray = createStructArrayType({ members: [{ type: "Int16", name: "anchorPointX" }, { type: "Int16", name: "anchorPointY" }, { type: "Float32", name: "tlX" }, { type: "Float32", name: "tlY" }, { type: "Float32", name: "trX" }, { type: "Float32", name: "trY" }, { type: "Float32", name: "blX" }, { type: "Float32", name: "blY" }, { type: "Float32", name: "brX" }, { type: "Float32", name: "brY" }, { type: "Int16", name: "texH" }, { type: "Int16", name: "texW" }, { type: "Int16", name: "texX" }, { type: "Int16", name: "texY" }, { type: "Float32", name: "anchorAngle" }, { type: "Float32", name: "glyphAngle" }, { type: "Float32", name: "maxScale" }, { type: "Float32", name: "minScale" }, { type: "Uint8", name: "writingMode" }] });
            Object.defineProperty(SymbolQuadsArray.prototype.StructType.prototype, "anchorPoint", { get: function() {
                    return new Point(this.anchorPointX, this.anchorPointY) } }), Object.defineProperty(SymbolQuadsArray.prototype.StructType.prototype, "SymbolQuad", { get: function() {
        ...
        }, { "../util/dom": 115, "./handler/box_zoom": 95, "./handler/dblclick_zoom": 96, "./handler/drag_pan": 97, "./handler/drag_rotate": 98, "./handler/keyboard": 99, "./handler/scroll_zoom": 100, "./handler/touch_zoom_rotate": 101, "point-geometry": 194 }],
        90: [function(require, module, exports) {
            ...
            var util = require("../util/util"),
                ...
                Evented = require("../util/evented"),
                Camera = function(t) {
                    function i(i, e) { t.call(this), this.transform = i, this._bearingSnap = e.bearingSnap }
                    return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.getCenter = function() {
                        ...
                        return this.jumpTo({ pitch: t }, i), this }, i.prototype.fitBounds = function(t, i, e) { i = util.extend({ padding: 0, offset: [0, 0], maxZoom: this.getMaxZoom() }, i), t = LngLatBounds.convert(t);
                        ...
                        return i.center = n.unproject(r.add(s).div(2)), i.zoom = Math.min(n.scaleZoom(n.scale * Math.min(h, u)), i.maxZoom), i.bearing = 0, i.linear ? this.easeTo(i, e) : this.flyTo(i, e) }, i.prototype.jumpTo = function(t, i) { this.stop();
                        var e = this.transform,
                            o = !1,
                            n = !1,
                            r = !1;
                        return "zoom" in t && e.zoom !== +t.zoom && (o = !0, e.zoom = +t.zoom), "center" in t && (e.center = LngLat.convert(t.center)), "bearing" in t && e.bearing !== +t.bearing && (n = !0, e.bearing = +t.bearing), "pitch" in t && e.pitch !== +t.pitch && (r = !0, e.pitch = +t.pitch), this.fire("movestart", i).fire("move", i), o && this.fire("zoomstart", i).fire("zoom", i).fire("zoomend", i), n && this.fire("rotate", i), r && this.fire("pitch", i), this.fire("moveend", i) }, i.prototype.easeTo = function(t, i) {
                        var e = this;
                        ...
                        var o, n, r = this.transform,
                            ...
                            m = "pitch" in t ? +t.pitch : u; "center" in t ? (o = LngLat.convert(t.center), n = r.centerPoint.add(s)) : "around" in t ? (o = LngLat.convert(t.around), n = r.locationPoint(o)) : (n = r.centerPoint.add(s), o = r.pointLocation(n));
                        var g = r.locationPoint(o);
                        return t.animate === !1 && (t.duration = 0), this.zooming = p !== a, this.rotating = h !== c, this.pitching = m !== u, t.smoothEasing && 0 !== t.duration && (t.easing = this._smoothOutEasing(t.duration)), t.noMoveStart || this.fire("movestart", i), this.zooming && this.fire("zoomstart", i), clearTimeout(this._onEaseEnd), this._ease(function(t) { this.zooming && (r.zoom = interpolate(a, p, t)), this.rotating && (r.bearing = interpolate(h, c, t)), this.pitching && (r.pitch = interpolate(u, m, t)), r.setLocationAtPoint(o, g.add(n.sub(g)._mult(t))), this.fire("move", i), this.zooming && this.fire("zoom", i), this.rotating && this.fire("rotate", i), this.pitching && this.fire("pitch", i) }, function() { t.delayEndEvents ? e._onEaseEnd = setTimeout(e._easeToEnd.bind(e, i), t.delayEndEvents) : e._easeToEnd(i) }, t), this }, i.prototype._easeToEnd = function(t) {
                        var i = this.zooming;
                        this.zooming = !1, this.rotating = !1, this.pitching = !1, i && this.fire("zoomend", t), this.fire("moveend", t) }, i.prototype.flyTo = function(t, i) {
                        function e(t) {
        ...
        }, { "../geo/lng_lat": 19, "../geo/lng_lat_bounds": 20, "../util/browser": 108, "../util/evented": 116, "../util/interpolate": 119, "../util/util": 127, "point-geometry": 194 }],
        91: [function(require, module, exports) {
            ...
            AttributionControl.prototype.getDefaultPosition = function() {
                ...
                if (this._editLink || (this._editLink = this._container.querySelector(".mapbox-improve-map")), this._editLink) {
                    ...
                    this._editLink.href = "https://www.mapbox.com/map-feedback/#/" + t.lng + "/" + t.lat + "/" + Math.round(this._map.getZoom() + 1) } }, AttributionControl.prototype._updateData = function(t) { "source" === t.dataType && (this._updateAttributions(), this._updateEditLink()) }, AttributionControl.prototype._updateAttributions = function() {
                if (this._map.style) {
                    var t = [],
        ...
        97: [function(require, module, exports) {
            ...
            DragPanHandler.prototype.isEnabled = function() {
                ...
                var n = 1,
                    i = 0;
                return "mousemove" === t.type ? t.buttons & 0 === n : t.button !== i }, DragPanHandler.prototype._drainInertiaBuffer = function() {
            ...
            DragRotateHandler.prototype.isEnabled = function() {
                ...
                if (!this._ignoreEvent(t)) { this.isActive() || (this._active = !0, this._fireEvent("rotatestart", t), this._fireEvent("movestart", t));
                    ...
                    var i = this._pos,
                        ...
                        h = this._inertia,
                        _ = h[h.length - 1];
                    this._drainInertiaBuffer(), h.push([Date.now(), e._normalizeBearing(o, _[1])]), e.transform.bearing = o, this._pitchWithRotate && (e.transform.pitch = s), this._fireEvent("rotate", t), this._fireEvent("move", t), this._pos = n } }, DragRotateHandler.prototype._onUp = function(t) {
                var e = this;
                if (!this._ignoreEvent(t) && (window.document.removeEventListener("mousemove", this._onMove), window.document.removeEventListener("mouseup", this._onUp), this.isActive())) { this._active = !1, this._fireEvent("rotateend", t), this._drainInertiaBuffer();
                    var i = this._map,
                        n = i.getBearing(),
                        r = this._inertia,
                        a = function() { Math.abs(n) < e._bearingSnap ? i.resetNorth({ noMoveStart: !0 }, { originalEvent: t }) : e._fireEvent("moveend", t) };
                    ...
                    var p = l / (inertiaDeceleration * inertiaLinearity),
                        g = u * l * (p / 2);
                    _ += g, Math.abs(i._normalizeBearing(_, 0)) < this._bearingSnap && (_ = i._normalizeBearing(0, _)), i.rotateTo(_, { duration: 1e3 * p, easing: inertiaEasing, noMoveStart: !0 }, { originalEvent: t }) } }, DragRotateHandler.prototype._fireEvent = function(t, e) {
                ...
                var i = t.ctrlKey ? 1 : 2,
                    n = t.ctrlKey ? 0 : 2,
                    r = t.button;
                return "undefined" != typeof InstallTrigger && 2 === t.button && t.ctrlKey && window.navigator.platform.toUpperCase().indexOf("MAC") >= 0 && (r = 0), "mousemove" === t.type ? t.buttons & 0 === i : r !== n }, DragRotateHandler.prototype._drainInertiaBuffer = function() {
        ...
        99: [function(require, module, exports) {
            ...
            KeyboardHandler.prototype.isEnabled = function() {
                ...
                if (!(e.altKey || e.ctrlKey || e.metaKey)) {
                    ...
                    var s = this._map,
                        o = s.getZoom(),
                        d = { duration: 300, delayEndEvents: 500, easing: easeOut, zoom: t ? Math.round(o) + t * (e.shiftKey ? 2 : 1) : o, bearing: s.getBearing() + n * bearingStep, pitch: s.getPitch() + a * pitchStep, offset: [-i * panStep, -r * panStep], center: s.getCenter() };
        ...
        100: [function(require, module, exports) {
            ...
            ScrollZoomHandler.prototype.isEnabled = function() {
                ...
                if (0 !== e) {
                    ...
                    o.zoomTo(s, { duration: "wheel" === this._type ? 200 : 0, around: o.unproject(this._pos), delayEndEvents: 200, smoothEasing: !0 }, { originalEvent: t }) } }, module.exports = ScrollZoomHandler;
            ...
            TouchZoomRotateHandler.prototype.isEnabled = function() {
                ...
                if (2 === t.touches.length) {
                    ...
                    if (this._gestureIntent) {
                        var h = { duration: 0, around: s.unproject(o) }; "rotate" === this._gestureIntent && (h.bearing = this._startBearing + r), "zoom" !== this._gestureIntent && "rotate" !== this._gestureIntent || (h.zoom = s.transform.scaleZoom(this._startScale * a)), s.stop(), this._drainInertiaBuffer(), this._inertia.push([Date.now(), a, o]), s.easeTo(h, { originalEvent: t }) } else {
                ...
                var o = e[e.length - 1],
                    n = e[0],
                    a = i.transform.scaleZoom(this._startScale * o[1]),
                    r = i.transform.scaleZoom(this._startScale * n[1]),
                    s = a - r,
                    h = (o[0] - n[0]) / 1e3,
                    u = o[2];
                ...
                var d = 1e3 * Math.abs(l / (inertiaDeceleration * inertiaLinearity)),
                    c = a + l * d / 2e3;
                c < 0 && (c = 0), i.easeTo({ zoom: c, duration: d, easing: inertiaEasing, around: i.unproject(u) }, { originalEvent: t }) }, TouchZoomRotateHandler.prototype._drainInertiaBuffer = function() {
                for (var t = this._inertia, e = Date.now(), i = 160; t.length > 2 && e - t[0][0] > i;) t.shift() }, module.exports = TouchZoomRotateHandler;
        }, { "../../util/dom": 115, "../../util/util": 127, "../../util/window": 110 }],
            ...
            var util = require("../util/util"),
                ...
                Map = function(t) {
                    ...
                    return e.prototype.addControl = function(t, e) { void 0 === e && t.getDefaultPosition && (e = t.getDefaultPosition()), void 0 === e && (e = "top-right");
                        ...
                        return e.indexOf("bottom") !== -1 ? o.insertBefore(i, o.firstChild) : o.appendChild(i), this }, e.prototype.removeControl = function(t) {
                        return t.onRemove(this), this }, e.prototype.addClass = function(t, e) {
                        return this._classes.indexOf(t) >= 0 || "" === t ? this : (this._classes.push(t), this._classOptions = e, this.style && this.style.updateClasses(), this._update(!0)) }, e.prototype.removeClass = function(t, e) {
                        var i = this._classes.indexOf(t);
                        return i < 0 || "" === t ? this : (this._classes.splice(i, 1), this._classOptions = e, this.style && this.style.updateClasses(), this._update(!0)) }, e.prototype.setClasses = function(t, e) {
                        for (var i = {}, o = 0; o < t.length; o++) "" !== t[o] && (i[t[o]] = !0);
                        return this._classes = Object.keys(i), this._classOptions = e, this.style && this.style.updateClasses(), this._update(!0) }, e.prototype.hasClass = function(t) {
                        return this._classes.indexOf(t) >= 0 }, e.prototype.getClasses = function() {
                        return this._classes }, e.prototype.resize = function() {
                        var t = this._containerDimensions(),
                            e = t[0],
                            i = t[1];
                        return this._resizeCanvas(e, i), this.transform.resize(e, i), this.painter.resize(e, i), this.fire("movestart").fire("move").fire("resize").fire("moveend") }, e.prototype.getBounds = function() {
                        ...
                        return this.transform.pointLocation(Point.convert(t)) }, e.prototype.queryRenderedFeatures = function() {
                        function t(t) {
                            return t instanceof Point || Array.isArray(t) }
                        var e, i = {};
                        return 2 === arguments.length ? (e = arguments[0], i = arguments[1]) : 1 === arguments.length && t(arguments[0]) ? e = arguments[0] : 1 === arguments.length && (i = arguments[0]), this.style.queryRenderedFeatures(this._makeQueryGeometry(e), i, this.transform.zoom, this.transform.angle) }, e.prototype._makeQueryGeometry = function(t) {
                        var e = this;
                        ...
                        return this.style.addSource(t, e), this._update(!0), this }, e.prototype.addSourceType = function(t, e, i) {
                        return this.style.addSourceType(t, e, i) }, e.prototype.removeSource = function(t) {
                        return this.style.removeSource(t), this._update(!0), this }, e.prototype.getSource = function(t) {
                        return this.style.getSource(t) }, e.prototype.addLayer = function(t, e) {
                        ...
                        return this.style.setFilter(t, e), this._update(!0), this }, e.prototype.setLayerZoomRange = function(t, e, i) {
                        return this.style.setLayerZoomRange(t, e, i), this._update(!0), this }, e.prototype.getFilter = function(t) {
                        return this.style.getFilter(t) }, e.prototype.setPaintProperty = function(t, e, i, o) {
                        return this.style.setPaintProperty(t, e, i, o), this._update(!0), this }, e.prototype.getPaintProperty = function(t, e, i) {
                        return this.style.getPaintProperty(t, e, i) }, e.prototype.setLayoutProperty = function(t, e, i) {
                        return this.style.setLayoutProperty(t, e, i), this._update(!0), this }, e.prototype.getLayoutProperty = function(t, e) {
                        ...
                        ["top-left", "top-right", "bottom-left", "bottom-right"].forEach(function(t) { s[t] = DOM.create("div", "mapboxgl-ctrl-" + t, o) }) }, e.prototype._resizeCanvas = function(t, e) {
                        var i = window.devicePixelRatio || 1;
                        this._canvas.width = i * t, this._canvas.height = i * e, this._canvas.style.width = t + "px", this._canvas.style.height = e + "px" }, e.prototype._setupPainter = function() {
                        ...
                        var i = e.getParameter(e.MAX_RENDERBUFFER_SIZE) / 2;
                        if (this._canvas.width > i || this._canvas.height > i) throw new Error("Map canvas (" + this._canvas.width + "x" + this._canvas.height + ") is larger than half of gl.MAX_RENDERBUFFER_SIZE (" + i + ")");
                        this.painter = new Painter(e, this.transform) }, e.prototype._contextLost = function(t) { t.preventDefault(), this._frameId && browser.cancelFrame(this._frameId), this.fire("webglcontextlost", { originalEvent: t }) }, e.prototype._contextRestored = function(t) { this._setupPainter(), this.resize(), this._update(), this.fire("webglcontextrestored", { originalEvent: t }) }, e.prototype.loaded = function() {
                        ...
                        t && t.loseContext(), removeNode(this._canvasContainer), removeNode(this._controlContainer), this._container.classList.remove("mapboxgl-map"), this.fire("remove") }, e.prototype._rerender = function() { this.style && !this._frameId && (this._frameId = browser.frame(this._render)) }, e.prototype._onWindowOnline = function() { this._update() }, e.prototype._onWindowResize = function() { this._trackResize && this.stop().resize()._update() }, i.showTileBoundaries.get = function() {
                        return !!this._showTileBoundaries }, i.showTileBoundaries.set = function(t) { this._showTileBoundaries !== t && (this._showTileBoundaries = t, this._update()) }, i.showCollisionBoxes.get = function() {
                        return !!this._showCollisionBoxes }, i.showCollisionBoxes.set = function(t) { this._showCollisionBoxes !== t && (this._showCollisionBoxes = t, this.style._redoPlacement()) }, i.showOverdrawInspector.get = function() {
                        return !!this._showOverdrawInspector }, i.showOverdrawInspector.set = function(t) { this._showOverdrawInspector !== t && (this._showOverdrawInspector = t, this._update()) }, i.repaint.get = function() {
                        return !!this._repaint }, i.repaint.set = function(t) { this._repaint = t, this._update() }, i.vertices.get = function() {
                        return !!this._vertices }, i.vertices.set = function(t) { this._vertices = t, this._update() }, e.prototype._onData = function(t) { this._update("style" === t.dataType), this.fire(t.dataType + "data", t) }, e.prototype._onDataLoading = function(t) { this.fire(t.dataType + "dataloading", t) }, Object.defineProperties(e.prototype, i), e }(Camera);
            module.exports = Map;
        }, { "../geo/lng_lat": 19, "../geo/lng_lat_bounds": 20, "../geo/transform": 21, "../render/painter": 36, "../style/animation_loop": 57, "../style/style": 61, "../util/browser": 108, "../util/dom": 115, "../util/util": 127, "../util/window": 110, "./bind_handlers": 89, "./camera": 90, "./control/attribution_control": 91, "./hash": 102, "mapbox-gl-supported": 190, "point-geometry": 194 }],
        ...
        }, { "../geo/lng_lat": 19, "../util/dom": 115, "../util/evented": 116, "../util/util": 127, "../util/window": 110, "point-geometry": 194 }],
        ...
        107: [function(require, module, exports) {
            ...
            exports.getJSON = function(e, n) {
                ...
                return t.open("GET", e, !0), t.setRequestHeader("Accept", "application/json"), t.onerror = function(e) { n(e) }, t.onload = function() {
                    if (t.status >= 200 && t.status < 300 && t.response) {
                        var e;
                        try { e = JSON.parse(t.response) } catch (e) {
                            return n(e) }
                        n(null, e) } else n(new Error(t.statusText)) }, t.send(), t }, exports.getArrayBuffer = function(e, n) {
                var t = new window.XMLHttpRequest;
                return t.open("GET", e, !0), t.responseType = "arraybuffer", t.onerror = function(e) { n(e) }, t.onload = function() {
                    return 0 === t.response.byteLength && 200 === t.status ? n(new Error("http status 200 returned without content.")) : void(t.status >= 200 && t.status < 300 && t.response ? n(null, t.response) : n(new Error(t.statusText))) }, t.send(), t };
            ...
            exports.getImage = function(e, n) {
                return exports.getArrayBuffer(e, function(e, t) {
                    ...
                    r.onload = function() { n(null, r), o.revokeObjectURL(r.src) };
                    var s = new window.Blob([new Uint8Array(t)], { type: "image/png" });
                    r.src = t.byteLength ? o.createObjectURL(s) : transparentPngUrl }) }, exports.getVideo = function(e, n) {
                var t = window.document.createElement("video");
                t.onloadstart = function() { n(null, t) };
        ...
        108: [function(require, module, exports) {
            ...
            exports.cancelFrame = function(e) { cancel(e) }, exports.timed = function(e, n, t) {
                ...
                var n = window.document.createElement("canvas"),
                    t = n.getContext("2d");
                return n.width = e.width, n.height = e.height, t.drawImage(e, 0, 0), t.getImageData(0, 0, e.width, e.height).data }, exports.supported = require("mapbox-gl-supported"), exports.hardwareConcurrency = window.navigator.hardwareConcurrency || 4, Object.defineProperty(exports, "devicePixelRatio", { get: function() {
        ...
        116: [function(require, module, exports) {
            ...
            Evented.prototype.on = function(e, t) {
                return this._listeners = this._listeners || {}, this._listeners[e] = this._listeners[e] || [], this._listeners[e].push(t), this }, Evented.prototype.off = function(e, t) {
                if (this._listeners && this._listeners[e]) {
                    var n = this._listeners[e].indexOf(t);
                    n !== -1 && this._listeners[e].splice(n, 1) }
                return this }, Evented.prototype.once = function(e, t) {
                var n = this,
                    s = function(i) { n.off(e, s), t.call(n, i) };
                return this.on(e, s), this }, Evented.prototype.fire = function(e, t) {
                var n = this;
                ...
                return this._listeners && this._listeners[e] || this._eventedParent && this._eventedParent.listens(e) }, Evented.prototype.setEventedParent = function(e, t) {
                return this._eventedParent = e, this._eventedParentData = "function" == typeof t ? t() : t, this }, module.exports = Evented;
        }, { "./util": 127 }],
        ...
        127: [function(require, module, exports) {
            ...
            exports.easeCubicInOut = function(r) {
                ...
                var e = r * r,
                    n = e * r;
                return 4 * (r < .5 ? n : 3 * (r - e) + n - .75) }, exports.bezier = function(r, e, n, t) {
                var o = new UnitBezier(r, e, n, t);
                return function(r) {
                    return o.solve(r) } }, exports.ease = exports.bezier(.25, .1, .25, 1), exports.clamp = function(r, e, n) {
                return Math.min(n, Math.max(e, r)) }, exports.wrap = function(r, e, n) {
                var t = n - e,
                    o = ((r - e) % t + t) % t + e;
                return o === e ? n : o }, exports.asyncAll = function(r, e, n) {
                if (!r.length) return n(null, []);
                var t = r.length,
                    o = new Array(r.length),
                    a = null;
                r.forEach(function(r, i) { e(r, function(r, e) { r && (a = r), o[i] = e, 0 === --t && n(a, o) }) }) }, exports.values = function(r) {
                var e = [];
                for (var n in r) e.push(r[n]);
                return e }, exports.keysDifference = function(r, e) {
                var n = [];
                for (var t in r) t in e || n.push(t);
                return n }, exports.extend = function(r, e, n, t) {
            ...
            exports.uniqueId = function() {
                ...
                var i = t - e,
                    u = o - n,
                    s = Math.max(i, u);
                return new Coordinate((e + t) / 2, (n + o) / 2, 0).zoomTo(Math.floor(-Math.log(s) / Math.LN2)) }, exports.endsWith = function(r, e) {
                return r.indexOf(e, r.length - e.length) !== -1 }, exports.mapObject = function(r, e, n) {
                var t = this,
                    o = {};
                for (var a in r) o[a] = e.call(n || t, r[a], a, r);
                return o }, exports.filterObject = function(r, e, n) {
                var t = this,
                    o = {};
                ...
                for (var n = 0; n < r.length; n++)
                    if (e.indexOf(r[n]) >= 0) return !0;
                return !1 };
            var warnOnceHistory = {};
            exports.warnOnce = function(r) { warnOnceHistory[r] || ("undefined" != typeof console && console.warn(r), warnOnceHistory[r] = !0) }, exports.isCounterClockwise = function(r, e, n) {
                return (n.y - r.y) * (e.x - r.x) > (e.y - r.y) * (n.x - r.x) }, exports.calculateSignedArea = function(r) {
                for (var e, n, t = 0, o = 0, a = r.length, i = a - 1; o < a; i = o++) e = r[o], n = r[i], t += (n.x - e.x) * (e.y + n.y);
                return t }, exports.isClosedPolygon = function(r) {
                if (r.length < 4) return !1;
                var e = r[0],
                    n = r[r.length - 1];
                return !(Math.abs(e.x - n.x) > 0 || Math.abs(e.y - n.y) > 0) && Math.abs(exports.calculateSignedArea(r)) > .01 }, exports.sphericalToCartesian = function(r) {
                var e = r[0],
                    n = r[1],
                    t = r[2];
        ...
        160: [function(require, module, exports) {
            ...
            function createFunction(t, o) {
                ...
                if (isFunctionDefinition(t)) {
                    ...
                    if (t.colorSpace && "rgb" !== t.colorSpace) {
                        ...
                        u = c.reverse } else u = identityFunction;
                    if (n === evaluateCategoricalFunction)
                        for (var f = Object.create(null), v = 0; v < t.stops.length; v++) f[t.stops[v][0]] = t.stops[v][1];
                    if (r) {
                        var y = {},
                            F = [];
                        for (l = 0; l < t.stops.length; l++) {
                            var d = t.stops[l];
                            void 0 === y[d[0].zoom] && (y[d[0].zoom] = { zoom: d[0].zoom, type: t.type, property: t.property, stops: [] }), y[d[0].zoom].stops.push([d[0].value, d[1]]) }
                        for (var h in y) F.push([y[h].zoom, createFunction(y[h])]);
                        e = function(o, e) {
                            return u(evaluateExponentialFunction({ stops: F, base: t.base }, o)(o, e)) }, e.isFeatureConstant = !1, e.isZoomConstant = !1 } else s ? (e = function(o) {
                        return u(n === evaluateCategoricalFunction ? n(t, o, f) : n(t, o)) }, e.isFeatureConstant = !0, e.isZoomConstant = !1) : (e = function(o, e) {
                        return u(n === evaluateCategoricalFunction ? n(t, e[t.property], f) : n(t, e[t.property])) }, e.isFeatureConstant = !1, e.isZoomConstant = !0) } else e = function() {
                    return t }, e.isFeatureConstant = !0, e.isZoomConstant = !0;
                return e }
            ...
            function binarySearchForIndex(t, o) {
                for (var e, n, r = t.length, i = 0, s = r - 1, a = 0; i <= s;) {
                    if (a = Math.floor((i + s) / 2), e = t[a][0], n = t[a + 1][0], o >= e && o < n) return a;
                    e < o ? i = a + 1 : e > o && (s = a - 1) }
            ...
            function interpolate(t, o, e, n, r, i) {
                return "function" == typeof r ? function() {
                    ...
                    return interpolate(t, o, e, n, s, a) } : r.length ? interpolateArray(t, o, e, n, r, i) : interpolateNumber(t, o, e, n, r, i) }
        ...
        161: [function(require, module, exports) {
            ...
            function deref(e, r) {
                ...
                return refProperties.forEach(function(e) { e in r && (f[e] = r[e]) }), f }

            function derefLayers(e) { e = e.slice();
        ...
        164: [function(require, module, exports) {
            ...
            function groupByLayout(r) {
                var e, t, i = {};
                for (e = 0; e < r.length; e++) { t = key(r[e]);
                    var u = i[t];
                    u || (u = i[t] = []), u.push(r[e]) }
                var n = [];
        ...
        175: [function(require, module, exports) {
            ...
            module.exports = function e(t) {
                ...
                return s };
        }, { "../error/validation_error": 163, "../util/get_type": 166, "../util/unbundle_jsonlint": 168, "./validate_enum": 174 }],
            ...
            module.exports = function(e) {
                ...
                function r(e) {
                    ...
                    if (s) {
                        ...
                        t = t.concat(validateObject({ key: o + "[0]", value: r[0], valueSpec: { zoom: {} }, style: e.style, styleSpec: e.styleSpec, objectElementValidators: { zoom: validateNumber, value: a } })) } else t = t.concat((i ? validateNumber : a)({ key: o + "[0]", value: r[0], valueSpec: {}, style: e.style, styleSpec: e.styleSpec }));
                    return t = t.concat(validate({ key: o + "[1]", value: r[1], valueSpec: n, style: e.style, styleSpec: e.styleSpec })), "number" === getType(r[0]) && ("piecewise-constant" === n.function && r[0] % 1 !== 0 && t.push(new ValidationError(o + "[0]", r[0], "zoom level for piecewise-constant functions must be an integer")), 0 !== e.arrayIndex && r[0] < e.array[e.arrayIndex - 1][0] && t.push(new ValidationError(o + "[0]", r[0], "array stops must appear in ascending order"))), t }

                function a(e) {
                    var t = getType(e.value);
                    if (o) {
                        if (t !== o) return [new ValidationError(e.key, e.value, "%s stop domain type must match previous stop domain type %s", t, o)] } else o = t, l || "string" !== t || (l = "categorical");
                ...
                var o, n = e.valueSpec,
                    l = unbundle(e.value.type),
                    i = void 0 === e.value.property,
                    u = void 0 !== e.value.property,
                    s = "array" === getType(e.value.stops) && "array" === getType(e.value.stops[0]) && "object" === getType(e.value.stops[0][0]),
                    p = validateObject({ key: e.key, value: e.value, valueSpec: e.styleSpec.function, style: e.style, styleSpec: e.styleSpec, objectElementValidators: { stops: t } });
        ...
        }, { "../error/validation_error": 163, "../util/get_type": 166, "../util/unbundle_jsonlint": 168, "./validate": 169, "./validate_array": 170, "./validate_number": 181, "./validate_object": 182 }],
        ...
        }, { "../error/validation_error": 163, "../util/extend": 165, "../util/unbundle_jsonlint": 168, "./validate_filter": 175, "./validate_layout_property": 179, "./validate_object": 182, "./validate_paint_property": 183 }],
            ...
            module.exports = function(e) {
                ...
                for (var p in t) {
                    ...
                    if (a[c]) s = a[c];
                        ...
                        if (!i["*"]) { n.push(new ValidationError(r, t[p], 'unknown property "%s"', p));
                            continue }
                        s = validateSpec }
                    n = n.concat(s({ key: (r ? r + "." : r) + p, value: t[p], valueSpec: d, style: o, styleSpec: l, object: t, objectKey: p })) }
        ...
        }, { "../error/validation_error": 163, "../util/unbundle_jsonlint": 168, "./validate_enum": 174, "./validate_object": 182 }],
        ...
        }, { "../reference/latest.min": 188, "./validate/validate": 169, "./validate/validate_constants": 173, "./validate/validate_filter": 175, "./validate/validate_glyphs_url": 177, "./validate/validate_layer": 178, "./validate/validate_layout_property": 179, "./validate/validate_light": 180, "./validate/validate_paint_property": 183, "./validate/validate_source": 184 }],
...
//https://api.tiles.mapbox.com/mapbox-gl-js/v0.30.0/mapbox-gl.js